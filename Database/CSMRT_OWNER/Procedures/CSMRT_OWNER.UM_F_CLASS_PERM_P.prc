CREATE OR REPLACE PROCEDURE             "UM_F_CLASS_PERM_P" AUTHID CURRENT_USER IS
...
insert /*+ append */ into UM_F_CLASS_PERM 
with
XL as (
...
COMMON_OWNER.SMT_LOG.PUT_MESSAGE(i_Message => strMessage01);
--alter table UM_F_CLASS_PERM enable constraint PK_UM_F_CLASS_PERM;
