DROP PROCEDURE CSMRT_OWNER.UM_M_AF_STDNT_ENRL_AMH_DAILY_P
/

--
-- UM_M_AF_STDNT_ENRL_AMH_DAILY_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_M_AF_STDNT_ENRL_AMH_DAILY_P" AUTHID CURRENT_USER IS
...
select trunc(SYSDATE) RUN_DT,
       ...
       SYSDATE CREATED_EW_DTTM,BIRTHDATE,SEX,ETHNIC_GRP_CD,CITIZENSHIP_STATUS,CITIZENSHIP_STATUS_LD,UM_CITIZENSHIP,UM_CITIZENSHIP_LD,
