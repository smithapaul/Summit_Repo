DROP PROCEDURE CSMRT_OWNER.UMOL_TERM_S2_P
/

--
-- UMOL_TERM_S2_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UMOL_TERM_S2_P" AUTHID CURRENT_USER IS

------------------------------------------------------------------------
-- Jim Doucette
--
-- Loads S2 table UMOL_TERM_S2 from S1 table UMOL_TERM_S1.
--
...
------------------------------------------------------------------------
        ...
        strProcessName                  Varchar2(100)   := 'UMOL_TERM_S2';
...
strMessage01    := 'Merging data into CSSTG_OWNER.UMOL_TERM_S2';
COMMON_OWNER.SMT_LOG.PUT_MESSAGE(i_Message => strMessage01);

strSqlCommand   := 'merge into CSSTG_OWNER.UMOL_TERM_S2';
merge /*+ use_hash(S,T) */ into CSSTG_OWNER.UMOL_TERM_S2 T
using (select /*+ full(S) */
       BB_SOURCE, 
	   PK1, 
	   NAME, 
	   ...
	   INSERT_TIME, 
	   UPDATE_TIME
  from CSSTG_OWNER.UMOL_TERM_S1) S
 on ( 
...
strMessage01    := '# of UMOL_TERM_S2 rows merged: ' || TO_CHAR(intRowCount,'999,999,999,999');
COMMON_OWNER.SMT_LOG.PUT_MESSAGE(i_Message => strMessage01);

strSqlCommand := 'SMT_PROCESS_LOG.PROCESS_DETAIL';
COMMON_OWNER.SMT_PROCESS_LOG.PROCESS_DETAIL
        (
                i_TargetTableName   => 'UMOL_TERM_S2',
                i_Action            => 'MERGE',
