DROP PROCEDURE CSMRT_OWNER.UM_D_CLASS_NOTES_P
/

--
-- UM_D_CLASS_NOTES_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_D_CLASS_NOTES_P" AUTHID CURRENT_USER IS
