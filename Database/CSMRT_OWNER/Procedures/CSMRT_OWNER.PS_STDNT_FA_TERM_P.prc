DROP PROCEDURE CSMRT_OWNER.PS_STDNT_FA_TERM_P
/

--
-- PS_STDNT_FA_TERM_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_STDNT_FA_TERM_P" AUTHID CURRENT_USER IS
