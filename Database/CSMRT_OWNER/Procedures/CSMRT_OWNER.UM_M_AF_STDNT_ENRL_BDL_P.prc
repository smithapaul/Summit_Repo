DROP PROCEDURE CSMRT_OWNER.UM_M_AF_STDNT_ENRL_BDL_P
/

--
-- UM_M_AF_STDNT_ENRL_BDL_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_M_AF_STDNT_ENRL_BDL_P" AUTHID CURRENT_USER IS
