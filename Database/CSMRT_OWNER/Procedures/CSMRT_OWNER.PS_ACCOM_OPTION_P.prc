DROP PROCEDURE CSMRT_OWNER.PS_ACCOM_OPTION_P
/

--
-- PS_ACCOM_OPTION_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER.PS_ACCOM_OPTION_P AUTHID CURRENT_USER IS
