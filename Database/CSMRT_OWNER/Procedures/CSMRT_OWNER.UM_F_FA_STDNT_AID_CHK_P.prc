DROP PROCEDURE CSMRT_OWNER.UM_F_FA_STDNT_AID_CHK_P
/

--
-- UM_F_FA_STDNT_AID_CHK_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_F_FA_STDNT_AID_CHK_P" AUTHID CURRENT_USER IS
