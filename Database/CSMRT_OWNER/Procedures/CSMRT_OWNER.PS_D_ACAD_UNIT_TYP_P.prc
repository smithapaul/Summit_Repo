DROP PROCEDURE CSMRT_OWNER.PS_D_ACAD_UNIT_TYP_P
/

--
-- PS_D_ACAD_UNIT_TYP_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_D_ACAD_UNIT_TYP_P" AUTHID CURRENT_USER IS
