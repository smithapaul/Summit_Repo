DROP PROCEDURE CSMRT_OWNER.UM_S_AF_STDNT_ENRL_AMH_NEW_P
/

--
-- UM_S_AF_STDNT_ENRL_AMH_NEW_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_S_AF_STDNT_ENRL_AMH_NEW_P" 
        (
...
END UM_S_AF_STDNT_ENRL_AMH_NEW_P;
/
