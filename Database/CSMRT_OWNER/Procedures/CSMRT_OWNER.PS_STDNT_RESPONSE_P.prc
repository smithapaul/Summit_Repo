DROP PROCEDURE CSMRT_OWNER.PS_STDNT_RESPONSE_P
/

--
-- PS_STDNT_RESPONSE_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_STDNT_RESPONSE_P" AUTHID CURRENT_USER IS
