DROP PROCEDURE CSMRT_OWNER.PS_STDNT_CR_TERM_P
/

--
-- PS_STDNT_CR_TERM_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_STDNT_CR_TERM_P" AUTHID CURRENT_USER IS
