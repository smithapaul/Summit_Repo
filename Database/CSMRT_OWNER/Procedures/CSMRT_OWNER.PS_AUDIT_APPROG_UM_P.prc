DROP PROCEDURE CSMRT_OWNER.PS_AUDIT_APPROG_UM_P
/

--
-- PS_AUDIT_APPROG_UM_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_AUDIT_APPROG_UM_P" AUTHID CURRENT_USER IS
