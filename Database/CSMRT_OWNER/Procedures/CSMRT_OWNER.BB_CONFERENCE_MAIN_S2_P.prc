DROP PROCEDURE CSMRT_OWNER.BB_CONFERENCE_MAIN_S2_P
/

--
-- BB_CONFERENCE_MAIN_S2_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."BB_CONFERENCE_MAIN_S2_P" AUTHID CURRENT_USER IS
