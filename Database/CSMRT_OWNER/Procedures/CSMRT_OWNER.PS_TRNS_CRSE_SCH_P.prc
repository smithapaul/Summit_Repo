DROP PROCEDURE CSMRT_OWNER.PS_TRNS_CRSE_SCH_P
/

--
-- PS_TRNS_CRSE_SCH_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER.PS_TRNS_CRSE_SCH_P AUTHID CURRENT_USER IS
