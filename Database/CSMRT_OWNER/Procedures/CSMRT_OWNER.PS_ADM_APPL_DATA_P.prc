DROP PROCEDURE CSMRT_OWNER.PS_ADM_APPL_DATA_P
/

--
-- PS_ADM_APPL_DATA_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_ADM_APPL_DATA_P" AUTHID CURRENT_USER IS
