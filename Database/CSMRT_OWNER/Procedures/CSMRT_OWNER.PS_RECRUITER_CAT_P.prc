DROP PROCEDURE CSMRT_OWNER.PS_RECRUITER_CAT_P
/

--
-- PS_RECRUITER_CAT_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_RECRUITER_CAT_P" AUTHID CURRENT_USER IS
