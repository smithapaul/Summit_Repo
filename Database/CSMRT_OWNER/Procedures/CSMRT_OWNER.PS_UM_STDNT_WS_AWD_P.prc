DROP PROCEDURE CSMRT_OWNER.PS_UM_STDNT_WS_AWD_P
/

--
-- PS_UM_STDNT_WS_AWD_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_UM_STDNT_WS_AWD_P" AUTHID CURRENT_USER IS
