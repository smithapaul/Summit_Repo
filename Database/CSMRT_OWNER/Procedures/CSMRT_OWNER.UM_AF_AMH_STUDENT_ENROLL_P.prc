DROP PROCEDURE CSMRT_OWNER.UM_AF_AMH_STUDENT_ENROLL_P
/

--
-- UM_AF_AMH_STUDENT_ENROLL_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER.UM_AF_AMH_STUDENT_ENROLL_P AUTHID CURRENT_USER IS
...
------------------------------------------------------------------------
        ...
        strProcessName                  Varchar2(100)   := 'UM_AF_AMH_STUDENT_ENROLL_S2';
...
END UM_AF_AMH_STUDENT_ENROLL_P;
/
