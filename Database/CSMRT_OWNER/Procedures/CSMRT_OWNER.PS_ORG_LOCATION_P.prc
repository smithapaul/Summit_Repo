DROP PROCEDURE CSMRT_OWNER.PS_ORG_LOCATION_P
/

--
-- PS_ORG_LOCATION_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_ORG_LOCATION_P" AUTHID CURRENT_USER IS
