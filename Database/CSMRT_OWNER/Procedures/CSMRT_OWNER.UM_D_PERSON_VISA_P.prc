DROP PROCEDURE CSMRT_OWNER.UM_D_PERSON_VISA_P
/

--
-- UM_D_PERSON_VISA_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_D_PERSON_VISA_P" AUTHID CURRENT_USER IS
