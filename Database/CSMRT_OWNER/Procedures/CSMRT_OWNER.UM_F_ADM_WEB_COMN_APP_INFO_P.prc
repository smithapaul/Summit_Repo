DROP PROCEDURE CSMRT_OWNER.UM_F_ADM_WEB_COMN_APP_INFO_P
/

--
-- UM_F_ADM_WEB_COMN_APP_INFO_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_F_ADM_WEB_COMN_APP_INFO_P" AUTHID CURRENT_USER IS
...
insert /*+ append enable_parallel_dml parallel(8) */ into CSMRT_OWNER.UM_F_ADM_WEB_COMN_APP_INFO
  with X as (
 ...
 where DATA_ORIGIN <> 'D'),
     ...
     nvl(X3.XLATLONGNAME,'-') UM_HIGH_EDUCLVL_P2,
	   ...
	   T.UM_ADM_WAIVER_OPTN,
        (select xlatlongname from CSSTG_OWNER.PSXLATITEM where fieldname ='UM_ADM_WAIVER_OPTN' and fieldvalue = UM_ADM_WAIVER_OPTN) adm_waiver_descr,
...
--       nvl(ATP6.DESCR,'-') UM_PARENT_CEEB_NM,
       ...
       1234 BATCH_SID,
       W_APP.UM_ADM_WAIVER_OPTN,   --Jan 2022
       W_APP.ADM_WAIVER_DESCR,     --Jan 2022
       W_APP.UM_ADM_ATTENDEE_CD   --Jan 2022
  FROM W_APP
