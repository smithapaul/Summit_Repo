DROP PROCEDURE CSMRT_OWNER.PS_ACAD_LOAD_TBL_P
/

--
-- PS_ACAD_LOAD_TBL_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_ACAD_LOAD_TBL_P" AUTHID CURRENT_USER IS
