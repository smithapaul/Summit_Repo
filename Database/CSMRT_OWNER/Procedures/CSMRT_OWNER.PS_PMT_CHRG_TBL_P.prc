DROP PROCEDURE CSMRT_OWNER.PS_PMT_CHRG_TBL_P
/

--
-- PS_PMT_CHRG_TBL_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_PMT_CHRG_TBL_P" AUTHID CURRENT_USER IS
