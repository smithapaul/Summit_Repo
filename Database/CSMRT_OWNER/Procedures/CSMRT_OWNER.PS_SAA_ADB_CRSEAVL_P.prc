DROP PROCEDURE CSMRT_OWNER.PS_SAA_ADB_CRSEAVL_P
/

--
-- PS_SAA_ADB_CRSEAVL_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_SAA_ADB_CRSEAVL_P" AUTHID CURRENT_USER IS
