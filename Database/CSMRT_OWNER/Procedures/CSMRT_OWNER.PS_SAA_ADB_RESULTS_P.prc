DROP PROCEDURE CSMRT_OWNER.PS_SAA_ADB_RESULTS_P
/

--
-- PS_SAA_ADB_RESULTS_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_SAA_ADB_RESULTS_P" AUTHID CURRENT_USER IS
