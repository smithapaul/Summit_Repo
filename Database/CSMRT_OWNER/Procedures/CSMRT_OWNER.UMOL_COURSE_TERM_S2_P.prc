DROP PROCEDURE CSMRT_OWNER.UMOL_COURSE_TERM_S2_P
/

--
-- UMOL_COURSE_TERM_S2_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UMOL_COURSE_TERM_S2_P" AUTHID CURRENT_USER IS
