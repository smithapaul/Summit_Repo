DROP PROCEDURE CSMRT_OWNER.PS_SSS_CRSE_PLNR_P
/

--
-- PS_SSS_CRSE_PLNR_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_SSS_CRSE_PLNR_P" AUTHID CURRENT_USER IS
