DROP PROCEDURE CSMRT_OWNER.UM_M_AF_STDNT_ENRL_AMH_OLD_P
/

--
-- UM_M_AF_STDNT_ENRL_AMH_OLD_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_M_AF_STDNT_ENRL_AMH_OLD_P" AUTHID CURRENT_USER IS
...
--alter table UM_M_AF_STDNT_ENRL_AMH disable constraint PK_UM_M_AF_STDNT_ENRL_AMH;
...
COMMON_OWNER.SMT_LOG.PUT_MESSAGE(i_Message => strMessage01);
--alter table UM_M_AF_STDNT_ENRL_AMH enable constraint PK_UM_M_AF_STDNT_ENRL_AMH;
...
END UM_M_AF_STDNT_ENRL_AMH_OLD_P;
/
