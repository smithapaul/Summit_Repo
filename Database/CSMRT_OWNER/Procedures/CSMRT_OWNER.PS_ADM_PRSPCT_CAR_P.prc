DROP PROCEDURE CSMRT_OWNER.PS_ADM_PRSPCT_CAR_P
/

--
-- PS_ADM_PRSPCT_CAR_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_ADM_PRSPCT_CAR_P" AUTHID CURRENT_USER IS
