DROP PROCEDURE CSMRT_OWNER.UM_D_PRSPCT_PROG_P
/

--
-- UM_D_PRSPCT_PROG_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_D_PRSPCT_PROG_P" AUTHID CURRENT_USER IS
