DROP PROCEDURE CSMRT_OWNER.UM_D_PRSPCT_CAR_P
/

--
-- UM_D_PRSPCT_CAR_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_D_PRSPCT_CAR_P" AUTHID CURRENT_USER IS
