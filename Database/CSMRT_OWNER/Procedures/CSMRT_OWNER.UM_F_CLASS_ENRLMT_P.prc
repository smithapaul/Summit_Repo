DROP PROCEDURE CSMRT_OWNER.UM_F_CLASS_ENRLMT_P
/

--
-- UM_F_CLASS_ENRLMT_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_F_CLASS_ENRLMT_P" AUTHID CURRENT_USER IS
...
insert /*+ append enable_parallel_dml parallel(8) */ into UM_F_CLASS_ENRLMT
with   
CLASS as (
...
--                       CLASS.TERM_CD,
                       ...
                       CASE
                          WHEN STAT.ENRLMT_STAT_ID <> 'E'       -- Add UMLOW placeholder fix?
                          THEN 0
                          WHEN FACT.INSTITUTION_CD = 'UMBOS' AND (FACT.SESSION_CD LIKE '%CE%' or FACT.SESSION_CD like 'SP%')   -- Nov 2020
