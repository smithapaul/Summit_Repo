DROP PROCEDURE CSMRT_OWNER.PS_EXT_ACAD_DATA_P
/

--
-- PS_EXT_ACAD_DATA_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_EXT_ACAD_DATA_P" AUTHID CURRENT_USER IS
