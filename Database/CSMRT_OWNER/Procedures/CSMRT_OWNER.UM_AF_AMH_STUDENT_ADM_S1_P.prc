DROP PROCEDURE CSMRT_OWNER.UM_AF_AMH_STUDENT_ADM_S1_P
/

--
-- UM_AF_AMH_STUDENT_ADM_S1_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_AF_AMH_STUDENT_ADM_S1_P"
        (
...
------------------------------------------------------------------------
--
-- Validates load of table COMMON_OWNER.UPLOAD_S1 for Amherst student admissions data.
--
...
------------------------------------------------------------------------
        ...
        strProcessName                  Varchar2(100)   := 'UM_AF_AMH_STUDENT_ADM_S1_P';
...
Else
        ...
        Else
                strMessage01    := 'UM_AF_AMH_STUDENT_ADM_S1_P is complete.';
        End If;
        COMMON_OWNER.SMT_LOG.PUT_MESSAGE(i_Message => strMessage01);
End If;
...
END UM_AF_AMH_STUDENT_ADM_S1_P;
/
