DROP PROCEDURE CSMRT_OWNER.PS_ITEM_TYPE_TBL_AMH_P
/

--
-- PS_ITEM_TYPE_TBL_AMH_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER.PS_ITEM_TYPE_TBL_AMH_P AUTHID CURRENT_USER IS
