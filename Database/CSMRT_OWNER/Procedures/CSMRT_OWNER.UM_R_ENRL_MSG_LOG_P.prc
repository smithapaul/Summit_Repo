DROP PROCEDURE CSMRT_OWNER.UM_R_ENRL_MSG_LOG_P
/

--
-- UM_R_ENRL_MSG_LOG_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_R_ENRL_MSG_LOG_P" AUTHID CURRENT_USER IS
