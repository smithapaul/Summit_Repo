DROP PROCEDURE CSMRT_OWNER.REBUILD_BITMAPS_SAA_COND_P
/

--
-- REBUILD_BITMAPS_SAA_COND_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER.REBUILD_BITMAPS_SAA_COND_P IS
...
END REBUILD_BITMAPS_SAA_COND_P;
/
