DROP PROCEDURE CSMRT_OWNER.PS_SESS_TIME_PEROD_P
/

--
-- PS_SESS_TIME_PEROD_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_SESS_TIME_PEROD_P" AUTHID CURRENT_USER IS
