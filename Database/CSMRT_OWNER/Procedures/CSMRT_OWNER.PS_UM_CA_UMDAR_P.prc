DROP PROCEDURE CSMRT_OWNER.PS_UM_CA_UMDAR_P
/

--
-- PS_UM_CA_UMDAR_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_UM_CA_UMDAR_P" AUTHID CURRENT_USER IS

------------------------------------------------------------------------
-- George Adams
--
-- Loads stage table PS_UM_CA_UMDAR from PeopleSoft table PS_UM_CA_UMDAR.
--
-- V01  SMT-xxxx 05/30/2017,    Jim Doucette
--                              Converted from PS_UM_CA_UMDAR.SQL
...
------------------------------------------------------------------------
        ...
        strProcessName                  Varchar2(100)   := 'PS_UM_CA_UMDAR';
...
update CSSTG_OWNER.UM_STAGE_JOBS
   set TABLE_STATUS = 'Reading',
       START_DT = sysdate,
       END_DT = NULL
 where TABLE_NAME = 'PS_UM_CA_UMDAR'
;
...
update CSSTG_OWNER.UM_STAGE_JOBS
   set TABLE_STATUS = 'Merging',
       NEW_MAX_SCN = (select /*+ full(S) */ max(ORA_ROWSCN) from SYSADM.PS_UM_CA_UMDAR@SASOURCE S)
 where TABLE_NAME = 'PS_UM_CA_UMDAR'
;
...
strMessage01    := 'Merging data into CSSTG_OWNER.PS_UM_CA_UMDAR';
COMMON_OWNER.SMT_LOG.PUT_MESSAGE(i_Message => strMessage01);

strSqlCommand   := 'merge into CSSTG_OWNER.PS_UM_CA_UMDAR';
merge /*+ use_hash(S,T) */ into CSSTG_OWNER.PS_UM_CA_UMDAR T
using (select /*+ full(S) */
    ...
    UM_ACAD1_QUES1 UM_ACAD1_QUES1,
    UM_COLL_NOW UM_COLL_NOW,
    UM_ACAD1_QUES3 UM_ACAD1_QUES3,
    ...
    UM_CA_AID_OPT UM_CA_AID_OPT,
    UM_CA_SLIDERM UM_CA_SLIDERM,
    UM_CA_1_PREF UM_CA_1_PREF,
    UM_CA_2_PREF UM_CA_2_PREF,
    UM_CA_ACTIVITY1 UM_CA_ACTIVITY1,
    UM_CA_ACTIVITY2 UM_CA_ACTIVITY2,
    UM_CA_ACTIVITY3 UM_CA_ACTIVITY3,
    UM_CA_ACTIVITY4 UM_CA_ACTIVITY4,
    UM_CA_ACTIVITY5 UM_CA_ACTIVITY5,
    UM_CA_PREV_APPLIED UM_CA_PREV_APPLIED,
    UM_CA_PREV_APPL_DT UM_CA_PREV_APPL_DT,
    UM_CA_CONTACT1 UM_CA_CONTACT1,
    UM_CA_CONTCT1_NAME UM_CA_CONTCT1_NAME,
    UM_CA_CONTCT_D1 UM_CA_CONTCT_D1,
    UM_CA_CONTACT2 UM_CA_CONTACT2,
    UM_CA_CONTCT2_NAME UM_CA_CONTCT2_NAME,
    UM_CA_CONTCT_D2 UM_CA_CONTCT_D2,
    UM_CA_CONTACT3 UM_CA_CONTACT3,
    UM_CA_CONTCT3_NAME UM_CA_CONTCT3_NAME,
    UM_CA_CONTCT_D3 UM_CA_CONTCT_D3,
    UM_CA_CONTACT4 UM_CA_CONTACT4,
    UM_CA_CONTCT4_NAME UM_CA_CONTCT4_NAME,
    UM_CA_CONTCT_D4 UM_CA_CONTCT_D4,
    UM_CA_CONTACT5 UM_CA_CONTACT5,
    UM_CA_CONTCT5_NAME UM_CA_CONTCT5_NAME,
    UM_CA_CONTCT_D5 UM_CA_CONTCT_D5,
    UM_CA_CONTACT6 UM_CA_CONTACT6,
    UM_CA_CONTCT6_NAME UM_CA_CONTCT6_NAME,
    UM_CA_CONTCT_D6 UM_CA_CONTCT_D6,
    UM_CA_CONTACT7 UM_CA_CONTACT7,
    UM_CA_CONTCT7_NAME UM_CA_CONTCT7_NAME,
    UM_CA_CONTCT_D7 UM_CA_CONTCT_D7,
    UM_CA_CONTACT8 UM_CA_CONTACT8,
    UM_CA_CONTCT8_NAME UM_CA_CONTCT8_NAME,
    UM_CA_CONTCT_D8 UM_CA_CONTCT_D8,
    UM_CA_CONTACT9 UM_CA_CONTACT9,
    UM_CA_CONTCT9_NAME UM_CA_CONTCT9_NAME,
    UM_CA_CONTCT_D9 UM_CA_CONTCT_D9,
    UM_CA_CONTACT10 UM_CA_CONTACT10,
    UM_CA_CNTCT10_NAME UM_CA_CNTCT10_NAME,
    UM_CA_CONTCT_D10 UM_CA_CONTCT_D10,
    ...
    UM_CA_PARNT_A_SERV UM_CA_PARNT_A_SERV,
    UM_CA_PARNT_ID_CD UM_CA_PARNT_ID_CD,
    UM_CA_PARNT_STATE UM_CA_PARNT_STATE,
    UM_CA_PARNT_DATE UM_CA_PARNT_DATE,
    UM_ADM_RESID_HALL UM_ADM_RESID_HALL,
    UM_CA_CAPE_VERDEAN UM_CA_CAPE_VERDEAN,
    UM_CA_HOLD_US_VISA UM_CA_HOLD_US_VISA,
    UM_CA_ARN_EXP_DT UM_CA_ARN_EXP_DT,
    UM_CA_VISA_OTHER UM_CA_VISA_OTHER,
    UM_CA_DATE_ISSUED UM_CA_DATE_ISSUED,
    UM_CA_INTEND_VISA UM_CA_INTEND_VISA,
    UM_CA_OTH_INT_VISA UM_CA_OTH_INT_VISA,
    UM_CA_PARNT_RES_TY UM_CA_PARNT_RES_TY,
    UM_CA_PRNT_ST_RES UM_CA_PRNT_ST_RES,
    UM_CA_PRNT_ST_STAY UM_CA_PRNT_ST_STAY,
    UM_CA_MERIT_SCHOLR UM_CA_MERIT_SCHOLR,
    UM_CA_GENDER_IDENT UM_CA_GENDER_IDENT,
    UM_CA_MIL_DISCHRG UM_CA_MIL_DISCHRG,
    UM_CA_PARNT_MAR_ST UM_CA_PARNT_MAR_ST,
    UM_CA_PARNT_DIV_YR UM_CA_PARNT_DIV_YR,
    UM_CA_PERM_HOME UM_CA_PERM_HOME,
    UM_CA_CHILDREN UM_CA_CHILDREN,
    UM_CA_NBR_CHILDREN UM_CA_NBR_CHILDREN,
...
from SYSADM.PS_UM_CA_UMDAR@SASOURCE S 
where ORA_ROWSCN > (select OLD_MAX_SCN from CSSTG_OWNER.UM_STAGE_JOBS where TABLE_NAME = 'PS_UM_CA_UMDAR') ) S
on ( 
    ...
    T.UM_ACAD1_QUES1 = S.UM_ACAD1_QUES1,
    T.UM_COLL_NOW = S.UM_COLL_NOW,
    T.UM_ACAD1_QUES3 = S.UM_ACAD1_QUES3,
    ...
    T.UM_CA_AID_OPT = S.UM_CA_AID_OPT,
    T.UM_CA_SLIDERM = S.UM_CA_SLIDERM,
    T.UM_CA_1_PREF = S.UM_CA_1_PREF,
    T.UM_CA_2_PREF = S.UM_CA_2_PREF,
    T.UM_CA_ACTIVITY1 = S.UM_CA_ACTIVITY1,
    T.UM_CA_ACTIVITY2 = S.UM_CA_ACTIVITY2,
    T.UM_CA_ACTIVITY3 = S.UM_CA_ACTIVITY3,
    T.UM_CA_ACTIVITY4 = S.UM_CA_ACTIVITY4,
    T.UM_CA_ACTIVITY5 = S.UM_CA_ACTIVITY5,
    T.UM_CA_PREV_APPLIED = S.UM_CA_PREV_APPLIED,
    T.UM_CA_PREV_APPL_DT = S.UM_CA_PREV_APPL_DT,
    T.UM_CA_CONTACT1 = S.UM_CA_CONTACT1,
    T.UM_CA_CONTCT1_NAME = S.UM_CA_CONTCT1_NAME,
    T.UM_CA_CONTCT_D1 = S.UM_CA_CONTCT_D1,
    T.UM_CA_CONTACT2 = S.UM_CA_CONTACT2,
    T.UM_CA_CONTCT2_NAME = S.UM_CA_CONTCT2_NAME,
    T.UM_CA_CONTCT_D2 = S.UM_CA_CONTCT_D2,
    T.UM_CA_CONTACT3 = S.UM_CA_CONTACT3,
    T.UM_CA_CONTCT3_NAME = S.UM_CA_CONTCT3_NAME,
    T.UM_CA_CONTCT_D3 = S.UM_CA_CONTCT_D3,
    T.UM_CA_CONTACT4 = S.UM_CA_CONTACT4,
    T.UM_CA_CONTCT4_NAME = S.UM_CA_CONTCT4_NAME,
    T.UM_CA_CONTCT_D4 = S.UM_CA_CONTCT_D4,
    T.UM_CA_CONTACT5 = S.UM_CA_CONTACT5,
    T.UM_CA_CONTCT5_NAME = S.UM_CA_CONTCT5_NAME,
    T.UM_CA_CONTCT_D5 = S.UM_CA_CONTCT_D5,
    T.UM_CA_CONTACT6 = S.UM_CA_CONTACT6,
    T.UM_CA_CONTCT6_NAME = S.UM_CA_CONTCT6_NAME,
    T.UM_CA_CONTCT_D6 = S.UM_CA_CONTCT_D6,
    T.UM_CA_CONTACT7 = S.UM_CA_CONTACT7,
    T.UM_CA_CONTCT7_NAME = S.UM_CA_CONTCT7_NAME,
    T.UM_CA_CONTCT_D7 = S.UM_CA_CONTCT_D7,
    T.UM_CA_CONTACT8 = S.UM_CA_CONTACT8,
    T.UM_CA_CONTCT8_NAME = S.UM_CA_CONTCT8_NAME,
    T.UM_CA_CONTCT_D8 = S.UM_CA_CONTCT_D8,
    T.UM_CA_CONTACT9 = S.UM_CA_CONTACT9,
    T.UM_CA_CONTCT9_NAME = S.UM_CA_CONTCT9_NAME,
    T.UM_CA_CONTCT_D9 = S.UM_CA_CONTCT_D9,
    T.UM_CA_CONTACT10 = S.UM_CA_CONTACT10,
    T.UM_CA_CNTCT10_NAME = S.UM_CA_CNTCT10_NAME,
    T.UM_CA_CONTCT_D10 = S.UM_CA_CONTCT_D10,
    ...
    T.UM_CA_PARNT_A_SERV = S.UM_CA_PARNT_A_SERV,
    T.UM_CA_PARNT_ID_CD = S.UM_CA_PARNT_ID_CD,
    T.UM_CA_PARNT_STATE = S.UM_CA_PARNT_STATE,
    T.UM_CA_PARNT_DATE = S.UM_CA_PARNT_DATE,
    T.UM_ADM_RESID_HALL = S.UM_ADM_RESID_HALL,
    T.UM_CA_CAPE_VERDEAN = S.UM_CA_CAPE_VERDEAN,
    T.UM_CA_HOLD_US_VISA = S.UM_CA_HOLD_US_VISA,
    T.UM_CA_ARN_EXP_DT = S.UM_CA_ARN_EXP_DT,
    T.UM_CA_VISA_OTHER = S.UM_CA_VISA_OTHER,
    T.UM_CA_DATE_ISSUED = S.UM_CA_DATE_ISSUED,
    T.UM_CA_INTEND_VISA = S.UM_CA_INTEND_VISA,
    T.UM_CA_OTH_INT_VISA = S.UM_CA_OTH_INT_VISA,
    ...
    T.UM_CA_MERIT_SCHOLR = S.UM_CA_MERIT_SCHOLR,
    T.UM_CA_GENDER_IDENT = S.UM_CA_GENDER_IDENT,
    T.UM_CA_MIL_DISCHRG = S.UM_CA_MIL_DISCHRG,
    T.UM_CA_PARNT_MAR_ST = S.UM_CA_PARNT_MAR_ST,
    T.UM_CA_PARNT_DIV_YR = S.UM_CA_PARNT_DIV_YR,
    T.UM_CA_PERM_HOME = S.UM_CA_PERM_HOME,
    T.UM_CA_CHILDREN = S.UM_CA_CHILDREN,
    T.UM_CA_NBR_CHILDREN = S.UM_CA_NBR_CHILDREN,
...
where 
    ...
    nvl(trim(T.UM_ACAD1_QUES1),0) <> nvl(trim(S.UM_ACAD1_QUES1),0) or 
    nvl(trim(T.UM_COLL_NOW),0) <> nvl(trim(S.UM_COLL_NOW),0) or 
    nvl(trim(T.UM_ACAD1_QUES3),0) <> nvl(trim(S.UM_ACAD1_QUES3),0) or 
    ...
    nvl(trim(T.UM_CA_AID_OPT),0) <> nvl(trim(S.UM_CA_AID_OPT),0) or 
    nvl(trim(T.UM_CA_SLIDERM),0) <> nvl(trim(S.UM_CA_SLIDERM),0) or 
    nvl(trim(T.UM_CA_1_PREF),0) <> nvl(trim(S.UM_CA_1_PREF),0) or 
    nvl(trim(T.UM_CA_2_PREF),0) <> nvl(trim(S.UM_CA_2_PREF),0) or 
    nvl(trim(T.UM_CA_ACTIVITY1),0) <> nvl(trim(S.UM_CA_ACTIVITY1),0) or 
    nvl(trim(T.UM_CA_ACTIVITY2),0) <> nvl(trim(S.UM_CA_ACTIVITY2),0) or 
    nvl(trim(T.UM_CA_ACTIVITY3),0) <> nvl(trim(S.UM_CA_ACTIVITY3),0) or 
    nvl(trim(T.UM_CA_ACTIVITY4),0) <> nvl(trim(S.UM_CA_ACTIVITY4),0) or 
    nvl(trim(T.UM_CA_ACTIVITY5),0) <> nvl(trim(S.UM_CA_ACTIVITY5),0) or 
    ...
    nvl(trim(T.UM_CA_CONTCT1_NAME),0) <> nvl(trim(S.UM_CA_CONTCT1_NAME),0) or 
    nvl(trim(T.UM_CA_CONTCT_D1),0) <> nvl(trim(S.UM_CA_CONTCT_D1),0) or 
    nvl(trim(T.UM_CA_CONTACT2),0) <> nvl(trim(S.UM_CA_CONTACT2),0) or 
    nvl(trim(T.UM_CA_CONTCT2_NAME),0) <> nvl(trim(S.UM_CA_CONTCT2_NAME),0) or 
    nvl(trim(T.UM_CA_CONTCT_D2),0) <> nvl(trim(S.UM_CA_CONTCT_D2),0) or 
    nvl(trim(T.UM_CA_CONTACT3),0) <> nvl(trim(S.UM_CA_CONTACT3),0) or 
    nvl(trim(T.UM_CA_CONTCT3_NAME),0) <> nvl(trim(S.UM_CA_CONTCT3_NAME),0) or 
    nvl(trim(T.UM_CA_CONTCT_D3),0) <> nvl(trim(S.UM_CA_CONTCT_D3),0) or 
    nvl(trim(T.UM_CA_CONTACT4),0) <> nvl(trim(S.UM_CA_CONTACT4),0) or 
    nvl(trim(T.UM_CA_CONTCT4_NAME),0) <> nvl(trim(S.UM_CA_CONTCT4_NAME),0) or 
    nvl(trim(T.UM_CA_CONTCT_D4),0) <> nvl(trim(S.UM_CA_CONTCT_D4),0) or 
    nvl(trim(T.UM_CA_CONTACT5),0) <> nvl(trim(S.UM_CA_CONTACT5),0) or 
    nvl(trim(T.UM_CA_CONTCT5_NAME),0) <> nvl(trim(S.UM_CA_CONTCT5_NAME),0) or 
    nvl(trim(T.UM_CA_CONTCT_D5),0) <> nvl(trim(S.UM_CA_CONTCT_D5),0) or 
    nvl(trim(T.UM_CA_CONTACT6),0) <> nvl(trim(S.UM_CA_CONTACT6),0) or 
    nvl(trim(T.UM_CA_CONTCT6_NAME),0) <> nvl(trim(S.UM_CA_CONTCT6_NAME),0) or 
    nvl(trim(T.UM_CA_CONTCT_D6),0) <> nvl(trim(S.UM_CA_CONTCT_D6),0) or 
    nvl(trim(T.UM_CA_CONTACT7),0) <> nvl(trim(S.UM_CA_CONTACT7),0) or 
    nvl(trim(T.UM_CA_CONTCT7_NAME),0) <> nvl(trim(S.UM_CA_CONTCT7_NAME),0) or 
    nvl(trim(T.UM_CA_CONTCT_D7),0) <> nvl(trim(S.UM_CA_CONTCT_D7),0) or 
    nvl(trim(T.UM_CA_CONTACT8),0) <> nvl(trim(S.UM_CA_CONTACT8),0) or 
    nvl(trim(T.UM_CA_CONTCT8_NAME),0) <> nvl(trim(S.UM_CA_CONTCT8_NAME),0) or 
    nvl(trim(T.UM_CA_CONTCT_D8),0) <> nvl(trim(S.UM_CA_CONTCT_D8),0) or 
    nvl(trim(T.UM_CA_CONTACT9),0) <> nvl(trim(S.UM_CA_CONTACT9),0) or 
    nvl(trim(T.UM_CA_CONTCT9_NAME),0) <> nvl(trim(S.UM_CA_CONTCT9_NAME),0) or 
    nvl(trim(T.UM_CA_CONTCT_D9),0) <> nvl(trim(S.UM_CA_CONTCT_D9),0) or 
    nvl(trim(T.UM_CA_CONTACT10),0) <> nvl(trim(S.UM_CA_CONTACT10),0) or 
    nvl(trim(T.UM_CA_CNTCT10_NAME),0) <> nvl(trim(S.UM_CA_CNTCT10_NAME),0) or 
    nvl(trim(T.UM_CA_CONTCT_D10),0) <> nvl(trim(S.UM_CA_CONTCT_D10),0) or 
    ...
    nvl(trim(T.UM_CA_PARNT_A_SERV),0) <> nvl(trim(S.UM_CA_PARNT_A_SERV),0) or 
    nvl(trim(T.UM_CA_PARNT_ID_CD),0) <> nvl(trim(S.UM_CA_PARNT_ID_CD),0) or 
    nvl(trim(T.UM_CA_PARNT_STATE),0) <> nvl(trim(S.UM_CA_PARNT_STATE),0) or 
    nvl(trim(T.UM_CA_PARNT_DATE),0) <> nvl(trim(S.UM_CA_PARNT_DATE),0) or 
    nvl(trim(T.UM_ADM_RESID_HALL),0) <> nvl(trim(S.UM_ADM_RESID_HALL),0) or 
    nvl(trim(T.UM_CA_CAPE_VERDEAN),0) <> nvl(trim(S.UM_CA_CAPE_VERDEAN),0) or 
    nvl(trim(T.UM_CA_HOLD_US_VISA),0) <> nvl(trim(S.UM_CA_HOLD_US_VISA),0) or 
    nvl(trim(T.UM_CA_ARN_EXP_DT),0) <> nvl(trim(S.UM_CA_ARN_EXP_DT),0) or 
    nvl(trim(T.UM_CA_VISA_OTHER),0) <> nvl(trim(S.UM_CA_VISA_OTHER),0) or 
    nvl(trim(T.UM_CA_DATE_ISSUED),0) <> nvl(trim(S.UM_CA_DATE_ISSUED),0) or 
    nvl(trim(T.UM_CA_INTEND_VISA),0) <> nvl(trim(S.UM_CA_INTEND_VISA),0) or 
    nvl(trim(T.UM_CA_OTH_INT_VISA),0) <> nvl(trim(S.UM_CA_OTH_INT_VISA),0) or 
    ...
    nvl(trim(T.UM_CA_MERIT_SCHOLR),0) <> nvl(trim(S.UM_CA_MERIT_SCHOLR),0) or 
    nvl(trim(T.UM_CA_GENDER_IDENT),0) <> nvl(trim(S.UM_CA_GENDER_IDENT),0) or 
    nvl(trim(T.UM_CA_MIL_DISCHRG),0) <> nvl(trim(S.UM_CA_MIL_DISCHRG),0) or 
    nvl(trim(T.UM_CA_PARNT_MAR_ST),0) <> nvl(trim(S.UM_CA_PARNT_MAR_ST),0) or 
    nvl(trim(T.UM_CA_PARNT_DIV_YR),0) <> nvl(trim(S.UM_CA_PARNT_DIV_YR),0) or 
    nvl(trim(T.UM_CA_PERM_HOME),0) <> nvl(trim(S.UM_CA_PERM_HOME),0) or 
    nvl(trim(T.UM_CA_CHILDREN),0) <> nvl(trim(S.UM_CA_CHILDREN),0) or 
    nvl(trim(T.UM_CA_NBR_CHILDREN),0) <> nvl(trim(S.UM_CA_NBR_CHILDREN),0) or 
...
insert (
    ...
    T.UM_CA_CONTACT1, 
    T.UM_CA_CONTCT1_NAME, 
    T.UM_CA_CONTCT_D1,
    T.UM_CA_CONTACT2, 
    T.UM_CA_CONTCT2_NAME, 
    T.UM_CA_CONTCT_D2,
    T.UM_CA_CONTACT3, 
    T.UM_CA_CONTCT3_NAME, 
    T.UM_CA_CONTCT_D3,
    T.UM_CA_CONTACT4, 
    T.UM_CA_CONTCT4_NAME, 
    T.UM_CA_CONTCT_D4,
    T.UM_CA_CONTACT5, 
    T.UM_CA_CONTCT5_NAME, 
    T.UM_CA_CONTCT_D5,
    T.UM_CA_CONTACT6, 
    T.UM_CA_CONTCT6_NAME, 
    T.UM_CA_CONTCT_D6,
    T.UM_CA_CONTACT7, 
    T.UM_CA_CONTCT7_NAME, 
    T.UM_CA_CONTCT_D7,
    T.UM_CA_CONTACT8, 
    T.UM_CA_CONTCT8_NAME, 
    T.UM_CA_CONTCT_D8,
    T.UM_CA_CONTACT9, 
    T.UM_CA_CONTCT9_NAME, 
    T.UM_CA_CONTCT_D9,
    T.UM_CA_CONTACT10,
    T.UM_CA_CNTCT10_NAME, 
    T.UM_CA_CONTCT_D10, 
    T.UM_CA_REL_ATT_MBR,
    T.UM_CA_REL_INF_CA, 
    T.UM_CA_REL1_REALTN,
    ...
    T.UM_CA_PARNT_A_SERV, 
    T.UM_CA_PARNT_ID_CD,
    T.UM_CA_PARNT_STATE,
    T.UM_CA_PARNT_DATE, 
    T.UM_ADM_RESID_HALL,
    T.UM_CA_CAPE_VERDEAN, 
    T.UM_CA_HOLD_US_VISA, 
    T.UM_CA_ARN_EXP_DT, 
    T.UM_CA_VISA_OTHER, 
    T.UM_CA_DATE_ISSUED,
    T.UM_CA_INTEND_VISA,
    T.UM_CA_OTH_INT_VISA, 
    T.UM_CA_PARNT_RES_TY, 
    T.UM_CA_PRNT_ST_RES,
    T.UM_CA_PRNT_ST_STAY, 
    T.UM_CA_MERIT_SCHOLR, 
    T.UM_CA_GENDER_IDENT, 
    T.UM_CA_MIL_DISCHRG,
    T.UM_CA_PARNT_MAR_ST, 
    T.UM_CA_PARNT_DIV_YR, 
    T.UM_CA_PERM_HOME,
    T.UM_CA_CHILDREN, 
    T.UM_CA_NBR_CHILDREN, 
...
values (
    ...
    S.UM_CA_CONTACT1, 
    S.UM_CA_CONTCT1_NAME, 
    S.UM_CA_CONTCT_D1,
    S.UM_CA_CONTACT2, 
    S.UM_CA_CONTCT2_NAME, 
    S.UM_CA_CONTCT_D2,
    S.UM_CA_CONTACT3, 
    S.UM_CA_CONTCT3_NAME, 
    S.UM_CA_CONTCT_D3,
    S.UM_CA_CONTACT4, 
    S.UM_CA_CONTCT4_NAME, 
    S.UM_CA_CONTCT_D4,
    S.UM_CA_CONTACT5, 
    S.UM_CA_CONTCT5_NAME, 
    S.UM_CA_CONTCT_D5,
    S.UM_CA_CONTACT6, 
    S.UM_CA_CONTCT6_NAME, 
    S.UM_CA_CONTCT_D6,
    S.UM_CA_CONTACT7, 
    S.UM_CA_CONTCT7_NAME, 
    S.UM_CA_CONTCT_D7,
    S.UM_CA_CONTACT8, 
    S.UM_CA_CONTCT8_NAME, 
    S.UM_CA_CONTCT_D8,
    S.UM_CA_CONTACT9, 
    S.UM_CA_CONTCT9_NAME, 
    S.UM_CA_CONTCT_D9,
    S.UM_CA_CONTACT10,
    S.UM_CA_CNTCT10_NAME, 
    S.UM_CA_CONTCT_D10, 
    S.UM_CA_REL_ATT_MBR,
    S.UM_CA_REL_INF_CA, 
    S.UM_CA_REL1_REALTN,
    ...
    S.UM_CA_PARNT_A_SERV, 
    S.UM_CA_PARNT_ID_CD,
    S.UM_CA_PARNT_STATE,
    S.UM_CA_PARNT_DATE, 
    S.UM_ADM_RESID_HALL,
    S.UM_CA_CAPE_VERDEAN, 
    S.UM_CA_HOLD_US_VISA, 
    S.UM_CA_ARN_EXP_DT, 
    S.UM_CA_VISA_OTHER, 
    S.UM_CA_DATE_ISSUED,
    S.UM_CA_INTEND_VISA,
    S.UM_CA_OTH_INT_VISA, 
    S.UM_CA_PARNT_RES_TY, 
    S.UM_CA_PRNT_ST_RES,
    S.UM_CA_PRNT_ST_STAY, 
    S.UM_CA_MERIT_SCHOLR, 
    S.UM_CA_GENDER_IDENT, 
    S.UM_CA_MIL_DISCHRG,
    S.UM_CA_PARNT_MAR_ST, 
    S.UM_CA_PARNT_DIV_YR, 
    S.UM_CA_PERM_HOME,
    S.UM_CA_CHILDREN, 
    S.UM_CA_NBR_CHILDREN, 
...
strMessage01    := '# of PS_UM_CA_UMDAR rows merged: ' || TO_CHAR(intRowCount,'999,999,999,999');
COMMON_OWNER.SMT_LOG.PUT_MESSAGE(i_Message => strMessage01);

strSqlCommand := 'SMT_PROCESS_LOG.PROCESS_DETAIL';
COMMON_OWNER.SMT_PROCESS_LOG.PROCESS_DETAIL
        (
                i_TargetTableName   => 'PS_UM_CA_UMDAR',
                i_Action            => 'MERGE',
...
strMessage01    := 'Updating DATA_ORIGIN on CSSTG_OWNER.PS_UM_CA_UMDAR';
COMMON_OWNER.SMT_LOG.PUT_MESSAGE(i_Message => strMessage01);

strSqlCommand   := 'update DATA_ORIGIN on CSSTG_OWNER.PS_UM_CA_UMDAR';
update CSSTG_OWNER.PS_UM_CA_UMDAR T
        set T.DATA_ORIGIN = 'D',
               T.LASTUPD_EW_DTTM = SYSDATE
...
(select UM_ADM_USERID, INSTITUTION, UM_ADM_REC_NBR, DATETIME_CREATED
   from CSSTG_OWNER.PS_UM_CA_UMDAR T2
  where (select DELETE_FLG from CSSTG_OWNER.UM_STAGE_JOBS where TABLE_NAME = 'PS_UM_CA_UMDAR') = 'Y'
  minus
 select nvl(trim(UM_ADM_USERID),'-') UM_ADM_USERID, INSTITUTION, UM_ADM_REC_NBR, DATETIME_CREATED
   from SYSADM.PS_UM_CA_UMDAR@SASOURCE S2
  where (select DELETE_FLG from CSSTG_OWNER.UM_STAGE_JOBS where TABLE_NAME = 'PS_UM_CA_UMDAR') = 'Y'
   ) S
...
strMessage01    := '# of PS_UM_CA_UMDAR rows updated: ' || TO_CHAR(intRowCount,'999,999,999,999');
COMMON_OWNER.SMT_LOG.PUT_MESSAGE(i_Message => strMessage01);
