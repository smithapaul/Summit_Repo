DROP PROCEDURE CSMRT_OWNER.PS_STDNT_AWARDS_P
/

--
-- PS_STDNT_AWARDS_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_STDNT_AWARDS_P" AUTHID CURRENT_USER IS
