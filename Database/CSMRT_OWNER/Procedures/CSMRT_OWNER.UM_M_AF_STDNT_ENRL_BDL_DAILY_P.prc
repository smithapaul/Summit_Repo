DROP PROCEDURE CSMRT_OWNER.UM_M_AF_STDNT_ENRL_BDL_DAILY_P
/

--
-- UM_M_AF_STDNT_ENRL_BDL_DAILY_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_M_AF_STDNT_ENRL_BDL_DAILY_P" AUTHID CURRENT_USER IS

------------------------------------------------------------------------
-- George Adams
--
-- Loads table UM_M_AF_STDNT_ENRL_BDL_DAILY.
--
...
------------------------------------------------------------------------
        ...
        strProcessName                  Varchar2(100)   := 'UM_M_AF_STDNT_ENRL_BDL_DAILY_P';
        strTargetTableOwner             Varchar2(128)   := 'CSMRT_OWNER';
        strTargetTableName              Varchar2(128)   := 'UM_M_AF_STDNT_ENRL_BDL_DAILY';
        strTarget                       Varchar2(100)   := 'CSMRT_OWNER.UM_M_AF_STDNT_ENRL_BDL_DAILY';
...
insert /*+ append */ into CSMRT_OWNER.UM_M_AF_STDNT_ENRL_BDL_DAILY
...
END UM_M_AF_STDNT_ENRL_BDL_DAILY_P;
/
