DROP PROCEDURE CSMRT_OWNER.PS_ANTICIPATED_AID_P
/

--
-- PS_ANTICIPATED_AID_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_ANTICIPATED_AID_P" AUTHID CURRENT_USER IS
