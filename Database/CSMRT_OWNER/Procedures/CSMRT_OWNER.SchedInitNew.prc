...
strSqlCommand   := 'SMT_PROCESS_LOG.SCHEDULE_INIT';
COMMON_OWNER.SMT_PROCESS_LOG.SCHEDULE_INIT
        (
                i_MartId                => i_MartId,
...
strMessage01    := 'Procedure COMMON_OWNER."SchedInitNew" arguments:'
