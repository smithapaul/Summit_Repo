DROP PROCEDURE CSMRT_OWNER.PS_D_ENRL_ACTION_P
/

--
-- PS_D_ENRL_ACTION_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_D_ENRL_ACTION_P" AUTHID CURRENT_USER IS
