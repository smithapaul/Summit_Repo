DROP PROCEDURE CSMRT_OWNER.UM_F_FA_AWARD_SUMM_BY_YEAR_P_OLD
/

--
-- UM_F_FA_AWARD_SUMM_BY_YEAR_P_OLD  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_F_FA_AWARD_SUMM_BY_YEAR_P_OLD" AUTHID CURRENT_USER IS
...
END UM_F_FA_AWARD_SUMM_BY_YEAR_P_OLD;
/
