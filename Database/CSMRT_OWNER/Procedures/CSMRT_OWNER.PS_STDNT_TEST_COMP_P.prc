DROP PROCEDURE CSMRT_OWNER.PS_STDNT_TEST_COMP_P
/

--
-- PS_STDNT_TEST_COMP_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_STDNT_TEST_COMP_P" AUTHID CURRENT_USER IS
