DROP PROCEDURE CSMRT_OWNER.PS_STDNT_EQUTN_VAR_P
/

--
-- PS_STDNT_EQUTN_VAR_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER.PS_STDNT_EQUTN_VAR_P AUTHID CURRENT_USER IS
