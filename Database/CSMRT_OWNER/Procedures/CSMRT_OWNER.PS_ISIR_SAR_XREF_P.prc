DROP PROCEDURE CSMRT_OWNER.PS_ISIR_SAR_XREF_P
/

--
-- PS_ISIR_SAR_XREF_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_ISIR_SAR_XREF_P" AUTHID CURRENT_USER IS
