DROP PROCEDURE CSMRT_OWNER.UM_D_CRSE_ATTR_VAL_P
/

--
-- UM_D_CRSE_ATTR_VAL_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_D_CRSE_ATTR_VAL_P" AUTHID CURRENT_USER IS
