DROP PROCEDURE CSMRT_OWNER.UM_D_CLASS_CHRSTC_P
/

--
-- UM_D_CLASS_CHRSTC_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_D_CLASS_CHRSTC_P" AUTHID CURRENT_USER IS
