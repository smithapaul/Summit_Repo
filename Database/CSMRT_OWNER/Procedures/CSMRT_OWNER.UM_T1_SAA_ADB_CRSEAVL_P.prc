DROP PROCEDURE CSMRT_OWNER.UM_T1_SAA_ADB_CRSEAVL_P
/

--
-- UM_T1_SAA_ADB_CRSEAVL_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_T1_SAA_ADB_CRSEAVL_P" AUTHID CURRENT_USER IS

------------------------------------------------------------------------
-- George Adams
--
-- Loads stage table UM_T1_SAA_ADB_CRSEAVL from PeopleSoft table UM_T1_SAA_ADB_CRSEAVL.
--
...
------------------------------------------------------------------------
        ...
        strProcessName                  Varchar2(100)   := 'UM_T1_SAA_ADB_CRSEAVL';
...
strMessage01    := 'Truncating table CSMRT_OWNER.UM_T1_SAA_ADB_CRSEAVL';
COMMON_OWNER.SMT_LOG.PUT_MESSAGE(i_Message => strMessage01);

strSqlDynamic   := 'truncate table CSMRT_OWNER.UM_T1_SAA_ADB_CRSEAVL';
...
strMessage01    := 'Inserting data into CSMRT_OWNER.UM_T1_SAA_ADB_CRSEAVL';
COMMON_OWNER.SMT_LOG.PUT_MESSAGE(i_Message => strMessage01);

strSqlCommand   := 'insert into CSMRT_OWNER.UM_T1_SAA_ADB_CRSEAVL';				
insert /*+ append */ into CSMRT_OWNER.UM_T1_SAA_ADB_CRSEAVL
with RES as (
...
--   and (R.INSTITUTION_CD = 'UMLOW' and R.SAA_CAREER_RPT = 'UGRD' and R.SAA_RPT_IDENTIFIER = 'LADVALL')
   and substr(EMPLID,-1,1) in ('0','1','2')
   ), 
OFF1 as (
select /*+ parallel(8) inline */
       O.CRSE_ID, 
...
strMessage01    := '# of UM_T1_SAA_ADB_CRSEAVL rows inserted: ' || TO_CHAR(intRowCount,'999,999,999,999');
COMMON_OWNER.SMT_LOG.PUT_MESSAGE(i_Message => strMessage01);

strSqlCommand := 'SMT_PROCESS_LOG.PROCESS_DETAIL';
COMMON_OWNER.SMT_PROCESS_LOG.PROCESS_DETAIL
        (
                i_TargetTableName   => 'UM_T1_SAA_ADB_CRSEAVL',
                i_Action            => 'INSERT',
