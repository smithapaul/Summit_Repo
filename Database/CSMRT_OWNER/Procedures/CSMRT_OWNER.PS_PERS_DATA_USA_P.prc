DROP PROCEDURE CSMRT_OWNER.PS_PERS_DATA_USA_P
/

--
-- PS_PERS_DATA_USA_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_PERS_DATA_USA_P" AUTHID CURRENT_USER IS
