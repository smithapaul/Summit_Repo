DROP PROCEDURE CSMRT_OWNER.UM_S_AF_STDNT_ENRL_AMH_FIX_P
/

--
-- UM_S_AF_STDNT_ENRL_AMH_FIX_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_S_AF_STDNT_ENRL_AMH_FIX_P" 
        (
