DROP PROCEDURE CSMRT_OWNER.PS_STDNT_ENRL_P
/

--
-- PS_STDNT_ENRL_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_STDNT_ENRL_P" AUTHID CURRENT_USER IS
...
------------------------------------------------------------------------
        ...
        strProcessName                  Varchar2(100)   := 'PS_STDNT_ENRL';
...
update CSSTG_OWNER.UM_STAGE_JOBS
   set TABLE_STATUS = 'Merging',
       NEW_MAX_SCN = (select /*+ full(S) */ max(ORA_ROWSCN) from SYSADM.PS_STDNT_ENRL@SASOURCE S)
 where TABLE_NAME = 'PS_STDNT_ENRL'
;
...
strMessage01    := 'Merging data into CSSTG_OWNER.PS_STDNT_ENRL';
COMMON_OWNER.SMT_LOG.PUT_MESSAGE(i_Message => strMessage01);

strSqlCommand   := 'merge into CSSTG_OWNER.PS_STDNT_ENRL';
merge /*+ use_hash(S,T) */ into CSSTG_OWNER.PS_STDNT_ENRL T
using (select /*+ full(S) */
...
from SYSADM.PS_STDNT_ENRL@SASOURCE S
where ORA_ROWSCN > (select OLD_MAX_SCN from CSSTG_OWNER.UM_STAGE_JOBS where TABLE_NAME = 'PS_STDNT_ENRL') 
...
strMessage01    := 'Updating DATA_ORIGIN on CSSTG_OWNER.PS_STDNT_ENRL';
COMMON_OWNER.SMT_LOG.PUT_MESSAGE(i_Message => strMessage01);

strSqlCommand   := 'update DATA_ORIGIN on CSSTG_OWNER.PS_STDNT_ENRL';
update CSSTG_OWNER.PS_STDNT_ENRL T
   set T.DATA_ORIGIN = 'D',
          T.LASTUPD_EW_DTTM = SYSDATE
...
(select EMPLID, ACAD_CAREER, INSTITUTION, STRM, CLASS_NBR
   from CSSTG_OWNER.PS_STDNT_ENRL T2
  where (select DELETE_FLG from CSSTG_OWNER.UM_STAGE_JOBS where TABLE_NAME = 'PS_STDNT_ENRL') = 'Y'
  minus
 select EMPLID, ACAD_CAREER, INSTITUTION, STRM, CLASS_NBR
   from SYSADM.PS_STDNT_ENRL@SASOURCE S2
  where (select DELETE_FLG from CSSTG_OWNER.UM_STAGE_JOBS where TABLE_NAME = 'PS_STDNT_ENRL') = 'Y'
   ) S
