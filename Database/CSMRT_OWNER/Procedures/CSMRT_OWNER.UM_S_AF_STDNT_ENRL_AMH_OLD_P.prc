DROP PROCEDURE CSMRT_OWNER.UM_S_AF_STDNT_ENRL_AMH_OLD_P
/

--
-- UM_S_AF_STDNT_ENRL_AMH_OLD_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_S_AF_STDNT_ENRL_AMH_OLD_P" AUTHID CURRENT_USER IS
...
--alter table UM_S_AF_STDNT_ENRL_AMH disable constraint PK_UM_S_AF_STDNT_ENRL_AMH;
...
values (
       ...
       S.PERSON_ID,
       S.SRC_SYS_ID,
       trunc(SYSDATE),                    -- EFFDT_START,
       trunc(SYSDATE),                    -- EFFDT_END,
       S.ACAD_YR,
       S.AID_YEAR,
       S.TERM_LD,
       S.ACAD_ORG_CD,
...
strMessage01    := '# of UM_S_AF_STDNT_ENRL_AMH rows inserted: ' || TO_CHAR(intRowCount,'999,999,999,999');
COMMON_OWNER.SMT_LOG.PUT_MESSAGE(i_Message => strMessage01);
...
COMMON_OWNER.SMT_LOG.PUT_MESSAGE(i_Message => strMessage01);
--alter table UM_S_AF_STDNT_ENRL_AMH enable constraint PK_UM_S_AF_STDNT_ENRL_AMH;
...
END UM_S_AF_STDNT_ENRL_AMH_OLD_P;
/
