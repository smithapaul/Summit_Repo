DROP PROCEDURE CSMRT_OWNER.UM_D_PERSON_ACCOM_P
/

--
-- UM_D_PERSON_ACCOM_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_D_PERSON_ACCOM_P" AUTHID CURRENT_USER IS
