DROP PROCEDURE CSMRT_OWNER.UM_AF_PRD_AMH_STDNT_ENRL_S2_P
/

--
-- UM_AF_PRD_AMH_STDNT_ENRL_S2_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_AF_PRD_AMH_STDNT_ENRL_S2_P" AUTHID CURRENT_USER IS
