DROP PROCEDURE CSMRT_OWNER.PS_SRVC_IN_RSN_TBL_P
/

--
-- PS_SRVC_IN_RSN_TBL_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER.PS_SRVC_IN_RSN_TBL_P AUTHID CURRENT_USER IS
