DROP PROCEDURE CSMRT_OWNER.UM_F_SAA_ADB_COND_CO_P
/

--
-- UM_F_SAA_ADB_COND_CO_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_F_SAA_ADB_COND_CO_P" AUTHID CURRENT_USER IS
...
insert /*+ append enable_parallel_dml parallel(8) */ into UM_F_SAA_ADB_COND
with
GRP1 as (
