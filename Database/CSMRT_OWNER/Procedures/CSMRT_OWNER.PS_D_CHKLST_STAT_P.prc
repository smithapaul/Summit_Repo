DROP PROCEDURE CSMRT_OWNER.PS_D_CHKLST_STAT_P
/

--
-- PS_D_CHKLST_STAT_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_D_CHKLST_STAT_P" AUTHID CURRENT_USER IS
