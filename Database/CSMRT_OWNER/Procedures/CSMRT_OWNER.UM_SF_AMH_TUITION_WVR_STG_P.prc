DROP PROCEDURE CSMRT_OWNER.UM_SF_AMH_TUITION_WVR_STG_P
/

--
-- UM_SF_AMH_TUITION_WVR_STG_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER.UM_SF_AMH_TUITION_WVR_STG_P AUTHID CURRENT_USER IS
