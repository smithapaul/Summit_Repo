DROP PROCEDURE CSMRT_OWNER.PS_UM_ITEM_TYPE_FA_P
/

--
-- PS_UM_ITEM_TYPE_FA_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_UM_ITEM_TYPE_FA_P" AUTHID CURRENT_USER IS
