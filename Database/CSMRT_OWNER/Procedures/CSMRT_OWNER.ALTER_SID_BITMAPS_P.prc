DROP PROCEDURE CSMRT_OWNER.ALTER_SID_BITMAPS_P
/

--
-- ALTER_SID_BITMAPS_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER.ALTER_SID_BITMAPS_P IS
