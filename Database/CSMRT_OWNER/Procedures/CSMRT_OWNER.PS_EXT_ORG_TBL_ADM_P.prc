DROP PROCEDURE CSMRT_OWNER.PS_EXT_ORG_TBL_ADM_P
/

--
-- PS_EXT_ORG_TBL_ADM_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_EXT_ORG_TBL_ADM_P" AUTHID CURRENT_USER IS
