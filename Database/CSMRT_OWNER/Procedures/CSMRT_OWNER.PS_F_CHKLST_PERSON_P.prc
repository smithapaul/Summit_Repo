DROP PROCEDURE CSMRT_OWNER.PS_F_CHKLST_PERSON_P
/

--
-- PS_F_CHKLST_PERSON_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_F_CHKLST_PERSON_P" AUTHID CURRENT_USER IS
