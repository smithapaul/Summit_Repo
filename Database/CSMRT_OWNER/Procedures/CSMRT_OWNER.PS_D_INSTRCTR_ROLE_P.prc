DROP PROCEDURE CSMRT_OWNER.PS_D_INSTRCTR_ROLE_P
/

--
-- PS_D_INSTRCTR_ROLE_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_D_INSTRCTR_ROLE_P" AUTHID CURRENT_USER IS
