DROP PROCEDURE CSMRT_OWNER.PS_RQ_GRP_DETL_TBL_P
/

--
-- PS_RQ_GRP_DETL_TBL_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_RQ_GRP_DETL_TBL_P" AUTHID CURRENT_USER IS
