DROP PROCEDURE CSMRT_OWNER.UM_AF_AMH_STUDENT_ADM_S2_P
/

--
-- UM_AF_AMH_STUDENT_ADM_S2_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER.UM_AF_AMH_STUDENT_ADM_S2_P AUTHID CURRENT_USER IS
