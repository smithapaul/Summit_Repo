DROP PROCEDURE CSMRT_OWNER.PS_CLASS_NOTES_TBL_P
/

--
-- PS_CLASS_NOTES_TBL_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER.PS_CLASS_NOTES_TBL_P AUTHID CURRENT_USER IS
