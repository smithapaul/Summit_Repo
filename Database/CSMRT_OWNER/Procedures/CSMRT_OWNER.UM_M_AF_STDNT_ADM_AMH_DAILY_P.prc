DROP PROCEDURE CSMRT_OWNER.UM_M_AF_STDNT_ADM_AMH_DAILY_P
/

--
-- UM_M_AF_STDNT_ADM_AMH_DAILY_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_M_AF_STDNT_ADM_AMH_DAILY_P"  
           (
