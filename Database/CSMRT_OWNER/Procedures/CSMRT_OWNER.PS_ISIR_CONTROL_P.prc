DROP PROCEDURE CSMRT_OWNER.PS_ISIR_CONTROL_P
/

--
-- PS_ISIR_CONTROL_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_ISIR_CONTROL_P" AUTHID CURRENT_USER IS
