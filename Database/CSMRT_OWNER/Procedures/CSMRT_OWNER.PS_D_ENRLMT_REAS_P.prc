DROP PROCEDURE CSMRT_OWNER.PS_D_ENRLMT_REAS_P
/

--
-- PS_D_ENRLMT_REAS_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_D_ENRLMT_REAS_P" AUTHID CURRENT_USER IS
