DROP PROCEDURE CSMRT_OWNER.UM_F_ACAD_PLAN_P
/

--
-- UM_F_ACAD_PLAN_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_F_ACAD_PLAN_P" AUTHID CURRENT_USER IS
...
insert /*+ append enable_parallel_dml parallel(8) */ into UM_F_ACAD_PLAN
with D1 as (
