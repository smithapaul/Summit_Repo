DROP PROCEDURE CSMRT_OWNER.PS_PERSON_CHK_ITEM_P
/

--
-- PS_PERSON_CHK_ITEM_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_PERSON_CHK_ITEM_P" AUTHID CURRENT_USER IS
