DROP PROCEDURE CSMRT_OWNER.PS_SFA_SAP_STDNT_P
/

--
-- PS_SFA_SAP_STDNT_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER.PS_SFA_SAP_STDNT_P AUTHID CURRENT_USER IS
