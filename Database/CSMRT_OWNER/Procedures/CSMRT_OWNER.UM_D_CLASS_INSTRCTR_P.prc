DROP PROCEDURE CSMRT_OWNER.UM_D_CLASS_INSTRCTR_P
/

--
-- UM_D_CLASS_INSTRCTR_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_D_CLASS_INSTRCTR_P" AUTHID CURRENT_USER IS
