DROP PROCEDURE CSMRT_OWNER.UM_F_ADM_APPL_ENRL_P
/

--
-- UM_F_ADM_APPL_ENRL_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_F_ADM_APPL_ENRL_P" AUTHID CURRENT_USER IS
...
insert /*+ append enable_parallel_dml parallel(8) */ into UM_F_ADM_APPL_ENRL
with TERM as (
select A.TERM_SID,
