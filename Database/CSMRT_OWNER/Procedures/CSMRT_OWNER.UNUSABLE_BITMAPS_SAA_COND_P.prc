DROP PROCEDURE CSMRT_OWNER.UNUSABLE_BITMAPS_SAA_COND_P
/

--
-- UNUSABLE_BITMAPS_SAA_COND_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER.UNUSABLE_BITMAPS_SAA_COND_P IS
