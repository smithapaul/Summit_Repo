DROP PROCEDURE CSMRT_OWNER.PS_ACCOM_REQUEST_P
/

--
-- PS_ACCOM_REQUEST_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER.PS_ACCOM_REQUEST_P AUTHID CURRENT_USER IS
