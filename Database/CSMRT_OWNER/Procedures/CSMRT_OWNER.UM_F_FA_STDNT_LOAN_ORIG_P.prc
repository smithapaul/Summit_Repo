DROP PROCEDURE CSMRT_OWNER.UM_F_FA_STDNT_LOAN_ORIG_P
/

--
-- UM_F_FA_STDNT_LOAN_ORIG_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_F_FA_STDNT_LOAN_ORIG_P" AUTHID CURRENT_USER IS
...
insert /*+ append enable_parallel_dml parallel(8) */ into UM_F_FA_STDNT_LOAN_ORIG
