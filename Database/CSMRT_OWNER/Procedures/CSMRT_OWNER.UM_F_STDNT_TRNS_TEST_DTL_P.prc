DROP PROCEDURE CSMRT_OWNER.UM_F_STDNT_TRNS_TEST_DTL_P
/

--
-- UM_F_STDNT_TRNS_TEST_DTL_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_F_STDNT_TRNS_TEST_DTL_P" AUTHID CURRENT_USER IS
