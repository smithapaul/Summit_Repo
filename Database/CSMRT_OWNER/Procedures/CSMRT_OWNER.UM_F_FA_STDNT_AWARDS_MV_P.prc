DROP PROCEDURE CSMRT_OWNER.UM_F_FA_STDNT_AWARDS_MV_P
/

--
-- UM_F_FA_STDNT_AWARDS_MV_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_F_FA_STDNT_AWARDS_MV_P" AUTHID CURRENT_USER IS
