DROP PROCEDURE CSMRT_OWNER.PS_ADM_PRSPCT_PLAN_P
/

--
-- PS_ADM_PRSPCT_PLAN_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_ADM_PRSPCT_PLAN_P" AUTHID CURRENT_USER IS
