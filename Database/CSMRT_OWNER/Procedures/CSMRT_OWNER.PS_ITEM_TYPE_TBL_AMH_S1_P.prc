...
------------------------------------------------------------------------
--
-- Loads table CSSTG_OWNER.PS_ITEM_TYPE_TBL from COMMON_OWNER.UPLOAD_S1.
--
-- V01  SMT-xxxx 04/29/2020,    George Adams
--
------------------------------------------------------------------------

        strMartId                       Varchar2(50)    := 'CSW';
        strProcessName                  Varchar2(100)   := 'PS_ITEM_TYPE_TBL_AMH_S1_P';
...
strMessage01    := 'Procedure CSMRT_OWNER."PS_ITEM_TYPE_TBL_AMH_P" input arguments:'
...
Else
        ...
        Else
                strMessage01    := 'PS_ITEM_TYPE_TBL_AMH_P is complete.';
        End If;
        COMMON_OWNER.SMT_LOG.PUT_MESSAGE(i_Message => strMessage01);
End If;
...
EXCEPTION
    WHEN OTHERS THEN
        ...
        Else
                COMMON_OWNER.SMT_LOG.PUT_MESSAGE(i_Message => 'PS_ITEM_TYPE_TBL_AMH_P has failed' || strNewLine || strSqlErrm);
        End If;

END PS_ITEM_TYPE_TBL_AMH_S1_P;
/
