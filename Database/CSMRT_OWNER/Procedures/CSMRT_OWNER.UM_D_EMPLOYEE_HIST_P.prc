DROP PROCEDURE CSMRT_OWNER.UM_D_EMPLOYEE_HIST_P
/

--
-- UM_D_EMPLOYEE_HIST_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_D_EMPLOYEE_HIST_P" AUTHID CURRENT_USER IS
