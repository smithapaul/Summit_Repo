DROP PROCEDURE CSMRT_OWNER.PS_VISA_PERMIT_TBL_P
/

--
-- PS_VISA_PERMIT_TBL_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER.PS_VISA_PERMIT_TBL_P AUTHID CURRENT_USER IS
