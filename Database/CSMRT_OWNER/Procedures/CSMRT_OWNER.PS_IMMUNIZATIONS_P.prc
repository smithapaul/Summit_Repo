DROP PROCEDURE CSMRT_OWNER.PS_IMMUNIZATIONS_P
/

--
-- PS_IMMUNIZATIONS_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER.PS_IMMUNIZATIONS_P AUTHID CURRENT_USER IS
