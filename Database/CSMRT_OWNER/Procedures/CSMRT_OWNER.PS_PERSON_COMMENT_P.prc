DROP PROCEDURE CSMRT_OWNER.PS_PERSON_COMMENT_P
/

--
-- PS_PERSON_COMMENT_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER.PS_PERSON_COMMENT_P AUTHID CURRENT_USER IS
