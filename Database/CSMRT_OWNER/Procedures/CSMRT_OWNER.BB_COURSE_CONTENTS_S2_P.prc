DROP PROCEDURE CSMRT_OWNER.BB_COURSE_CONTENTS_S2_P
/

--
-- BB_COURSE_CONTENTS_S2_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."BB_COURSE_CONTENTS_S2_P" AUTHID CURRENT_USER IS
