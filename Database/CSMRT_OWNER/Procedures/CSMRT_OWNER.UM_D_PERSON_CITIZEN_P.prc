DROP PROCEDURE CSMRT_OWNER.UM_D_PERSON_CITIZEN_P
/

--
-- UM_D_PERSON_CITIZEN_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_D_PERSON_CITIZEN_P" AUTHID CURRENT_USER IS
