DROP PROCEDURE CSMRT_OWNER.PS_RESIDENCY_APEAL_P
/

--
-- PS_RESIDENCY_APEAL_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER.PS_RESIDENCY_APEAL_P AUTHID CURRENT_USER IS
