DROP PROCEDURE CSMRT_OWNER.PS_ISIR_COMMENTS_P
/

--
-- PS_ISIR_COMMENTS_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_ISIR_COMMENTS_P" AUTHID CURRENT_USER IS
