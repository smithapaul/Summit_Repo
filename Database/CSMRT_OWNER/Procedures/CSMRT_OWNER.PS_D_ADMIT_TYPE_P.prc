DROP PROCEDURE CSMRT_OWNER.PS_D_ADMIT_TYPE_P
/

--
-- PS_D_ADMIT_TYPE_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER.PS_D_ADMIT_TYPE_P AUTHID CURRENT_USER IS
