DROP PROCEDURE CSMRT_OWNER.PS_AWD_ADJ_RSN_TBL_P
/

--
-- PS_AWD_ADJ_RSN_TBL_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER.PS_AWD_ADJ_RSN_TBL_P AUTHID CURRENT_USER IS
