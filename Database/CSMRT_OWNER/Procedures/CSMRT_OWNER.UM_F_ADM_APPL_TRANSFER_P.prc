DROP PROCEDURE CSMRT_OWNER.UM_F_ADM_APPL_TRANSFER_P
/

--
-- UM_F_ADM_APPL_TRANSFER_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_F_ADM_APPL_TRANSFER_P" AUTHID CURRENT_USER IS
