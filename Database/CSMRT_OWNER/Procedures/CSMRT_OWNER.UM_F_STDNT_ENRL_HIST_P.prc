DROP PROCEDURE CSMRT_OWNER.UM_F_STDNT_ENRL_HIST_P
/

--
-- UM_F_STDNT_ENRL_HIST_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_F_STDNT_ENRL_HIST_P" AUTHID CURRENT_USER IS
...
insert /*+ append enable_parallel_dml parallel(8) */ into UM_F_STDNT_ENRL_HIST
   WITH
        R1
        as (
