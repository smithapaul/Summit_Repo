DROP PROCEDURE CSMRT_OWNER.UM_D_PRSPCT_PLAN_P
/

--
-- UM_D_PRSPCT_PLAN_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_D_PRSPCT_PLAN_P" AUTHID CURRENT_USER IS
