DROP PROCEDURE CSMRT_OWNER.UM_F_SAA_ADB_COND_P
/

--
-- UM_F_SAA_ADB_COND_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."UM_F_SAA_ADB_COND_P" AUTHID CURRENT_USER IS
