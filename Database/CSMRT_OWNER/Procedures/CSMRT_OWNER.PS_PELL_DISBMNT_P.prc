DROP PROCEDURE CSMRT_OWNER.PS_PELL_DISBMNT_P
/

--
-- PS_PELL_DISBMNT_P  (Procedure) 
--
CREATE OR REPLACE PROCEDURE CSMRT_OWNER."PS_PELL_DISBMNT_P" AUTHID CURRENT_USER IS
