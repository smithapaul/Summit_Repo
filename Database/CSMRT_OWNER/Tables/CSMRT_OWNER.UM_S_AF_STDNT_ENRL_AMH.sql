DROP TABLE CSMRT_OWNER.UM_S_AF_STDNT_ENRL_AMH CASCADE CONSTRAINTS
/

--
-- UM_S_AF_STDNT_ENRL_AMH  (Table) 
--
CREATE TABLE CSMRT_OWNER.UM_S_AF_STDNT_ENRL_AMH
(
...
ALTER TABLE CSMRT_OWNER.UM_S_AF_STDNT_ENRL_AMH ADD (
  CONSTRAINT PK_UM_S_AF_STDNT_ENRL_AMH
  PRIMARY KEY
