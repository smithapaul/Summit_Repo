DROP TABLE CSMRT_OWNER.UM_M_AF_STDNT_ENRL_BDL_DAILY CASCADE CONSTRAINTS
/

--
-- UM_M_AF_STDNT_ENRL_BDL_DAILY  (Table) 
--
CREATE TABLE CSMRT_OWNER.UM_M_AF_STDNT_ENRL_BDL_DAILY
(
