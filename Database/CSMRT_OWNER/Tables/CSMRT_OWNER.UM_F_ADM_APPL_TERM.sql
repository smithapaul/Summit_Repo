DROP TABLE CSMRT_OWNER.UM_F_ADM_APPL_TERM CASCADE CONSTRAINTS
/

--
-- UM_F_ADM_APPL_TERM  (Table) 
--
CREATE TABLE CSMRT_OWNER.UM_F_ADM_APPL_TERM
(
  ADM_APPL_SID                NUMBER(10)        NOT NULL,
