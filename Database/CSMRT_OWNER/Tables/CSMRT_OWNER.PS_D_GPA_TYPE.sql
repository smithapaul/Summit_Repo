DROP TABLE CSMRT_OWNER.PS_D_GPA_TYPE CASCADE CONSTRAINTS
/

--
-- PS_D_GPA_TYPE  (Table) 
--
CREATE TABLE CSMRT_OWNER.PS_D_GPA_TYPE
(
  GPA_TYPE_SID     INTEGER                      NOT NULL,
  INSTITUTION_CD   VARCHAR2(5 CHAR)             NOT NULL,
  GPA_TYPE_ID      VARCHAR2(4 CHAR)             NOT NULL,
  SRC_SYS_ID       VARCHAR2(5 CHAR)             NOT NULL,
  EFFDT            DATE,
  EFF_STAT_CD      VARCHAR2(1 CHAR)             NOT NULL,
  GPA_TYPE_SD      VARCHAR2(10 CHAR)            NOT NULL,
  GPA_TYPE_LD      VARCHAR2(30 CHAR)            NOT NULL,
