DROP TABLE CSMRT_OWNER.PS_D_ACAD_GRP CASCADE CONSTRAINTS
/

--
-- PS_D_ACAD_GRP  (Table) 
--
CREATE TABLE CSMRT_OWNER.PS_D_ACAD_GRP
(
  ACAD_GRP_SID      INTEGER                     NOT NULL,
  EFFDT             DATE                        NOT NULL,
  INSTITUTION_CD    VARCHAR2(5 CHAR)            NOT NULL,
  ACAD_GRP_CD       VARCHAR2(5 CHAR)            NOT NULL,
  ...
  ACAD_GRP_SD       VARCHAR2(10 CHAR)           NOT NULL,
  ACAD_GRP_LD       VARCHAR2(30 CHAR)           NOT NULL,
  ACAD_GRP_CD_DESC  VARCHAR2(50 CHAR)           NOT NULL,
