CREATE TABLE UM_F_FA_STDNT_BDGT
(
  ...
  FIN_AID_FED_RES_SID    INTEGER,
  FIN_AID_ST_RES_SID     INTEGER,
  FIN_AID_FED_EXCPT_SID  INTEGER,
  FIN_AID_ST_EXCPT_SID   INTEGER,
  RESIDENCY_SID          INTEGER,
