DROP TABLE CSMRT_OWNER.UM_F_SF_ITEM CASCADE CONSTRAINTS
/

--
-- UM_F_SF_ITEM  (Table) 
--
CREATE TABLE CSMRT_OWNER.UM_F_SF_ITEM
(
...
ALTER TABLE CSMRT_OWNER.UM_F_SF_ITEM ADD (
  CONSTRAINT PK_UM_F_SF_ITEM
  PRIMARY KEY
