DROP TABLE CSMRT_OWNER.UM_M_AF_STDNT_ENRL_AMH_DAILY CASCADE CONSTRAINTS
/

--
-- UM_M_AF_STDNT_ENRL_AMH_DAILY  (Table) 
--
CREATE TABLE CSMRT_OWNER.UM_M_AF_STDNT_ENRL_AMH_DAILY
(
