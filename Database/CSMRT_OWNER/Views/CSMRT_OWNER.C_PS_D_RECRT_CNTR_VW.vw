DROP VIEW CSMRT_OWNER.C_PS_D_RECRT_CNTR_VW
/

--
-- C_PS_D_RECRT_CNTR_VW  (View) 
--
CREATE OR REPLACE VIEW CSMRT_OWNER.C_PS_D_RECRT_CNTR_VW
BEQUEATH DEFINER
AS 
WITH  INST as (
   ...
   SELECT CAST(D.RECRT_CNTR_SID AS NUMBER(10))      RECRT_CNTR_SID,  
	 ...
	 FROM CSMRT_OWNER.PS_D_RECRT_CNTR D
