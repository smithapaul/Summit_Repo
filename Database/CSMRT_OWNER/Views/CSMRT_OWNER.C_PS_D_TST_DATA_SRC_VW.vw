DROP VIEW CSMRT_OWNER.C_PS_D_TST_DATA_SRC_VW
/

--
-- C_PS_D_TST_DATA_SRC_VW  (View) 
--
CREATE OR REPLACE VIEW CSMRT_OWNER.C_PS_D_TST_DATA_SRC_VW
BEQUEATH DEFINER
AS 
SELECT CAST(TST_DATA_SRC_SID AS NUMBER(10))      TST_DATA_SRC_SID,  
		TST_DATA_SRC_ID, 
   ...
   FROM CSMRT_OWNER.PS_D_TST_DATA_SRC  
  WHERE DATA_ORIGIN <> 'D'
/
