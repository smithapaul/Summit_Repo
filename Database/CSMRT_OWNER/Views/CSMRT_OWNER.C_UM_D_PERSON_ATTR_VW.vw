DROP VIEW CSMRT_OWNER.C_UM_D_PERSON_ATTR_VW
/

--
-- C_UM_D_PERSON_ATTR_VW  (View) 
--
CREATE OR REPLACE VIEW CSMRT_OWNER.C_UM_D_PERSON_ATTR_VW
BEQUEATH DEFINER
AS 
WITH
        RSD
    ...
    SELECT P.PERSON_SID,
           ...
           NVL (CS.DESCR, '-')
               CITZ_STAT_LD,
           P.BIRTH_COUNTRY
               CITZ_CNTRY_CD,                       -- Same as home country???
           P.BIRTH_COUNTRY_SD
               CITZ_CNTRY_SD,                       -- Same as home country???
           P.BIRTH_COUNTRY_LD
               CITZ_CNTRY_LD,                       -- Same as home country???
