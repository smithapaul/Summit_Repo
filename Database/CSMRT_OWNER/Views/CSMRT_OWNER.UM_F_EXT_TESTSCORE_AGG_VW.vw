DROP VIEW CSMRT_OWNER.UM_F_EXT_TESTSCORE_AGG_VW
/

--
-- UM_F_EXT_TESTSCORE_AGG_VW  (View) 
--
CREATE OR REPLACE VIEW CSMRT_OWNER.UM_F_EXT_TESTSCORE_AGG_VW
BEQUEATH DEFINER
AS 
SELECT PERSON_SID,
           SRC_SYS_ID,
           ...
           (SAT_ERWS_SCORE + SAT_MSS_SCORE) SAT_TOTAL_UM_SCORE,
           SAT_VERB_SCORE,
           SAT_WLT_SCORE,
           SAT_WLT_CONV_SCORE,
           SAT_WR_SCORE,
