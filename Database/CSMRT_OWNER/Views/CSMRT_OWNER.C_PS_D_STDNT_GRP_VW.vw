DROP VIEW CSMRT_OWNER.C_PS_D_STDNT_GRP_VW
/

--
-- C_PS_D_STDNT_GRP_VW  (View) 
--
CREATE OR REPLACE VIEW CSMRT_OWNER.C_PS_D_STDNT_GRP_VW
BEQUEATH DEFINER
AS 
WITH  INST as (
    ...
    SELECT CAST(D.STDNT_GRP_SID AS NUMBER(10)) STDNT_GRP_SID,
      ...
      FROM csmrt_owner.PS_D_STDNT_GRP D	  
