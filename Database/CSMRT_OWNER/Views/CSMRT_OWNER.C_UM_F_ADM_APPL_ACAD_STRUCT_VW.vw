DROP VIEW CSMRT_OWNER.C_UM_F_ADM_APPL_ACAD_STRUCT_VW
/

--
-- C_UM_F_ADM_APPL_ACAD_STRUCT_VW  (View) 
--
CREATE OR REPLACE VIEW CSMRT_OWNER.C_UM_F_ADM_APPL_ACAD_STRUCT_VW
BEQUEATH DEFINER
AS 
SELECT ADM_APPL_SID,
           TERM_SID,
