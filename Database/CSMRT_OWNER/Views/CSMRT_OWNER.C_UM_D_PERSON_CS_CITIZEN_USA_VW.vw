DROP VIEW CSMRT_OWNER.C_UM_D_PERSON_CS_CITIZEN_USA_VW
/

--
-- C_UM_D_PERSON_CS_CITIZEN_USA_VW  (View) 
--
CREATE OR REPLACE VIEW CSMRT_OWNER.C_UM_D_PERSON_CS_CITIZEN_USA_VW
BEQUEATH DEFINER
AS 
