DROP VIEW CSMRT_OWNER.C_UM_D_ADMIT_TYPE_VW
/

--
-- C_UM_D_ADMIT_TYPE_VW  (View) 
--
CREATE OR REPLACE VIEW CSMRT_OWNER.C_UM_D_ADMIT_TYPE_VW
BEQUEATH DEFINER
AS 
WITH  INST as (
 ...
 SELECT CAST(D.ADMIT_TYPE_SID AS NUMBER(10))       ADMIT_TYPE_SID,  
		...
		D.ADMIT_TYPE_SD, 
		D.ADMIT_TYPE_LD, 
		SUBSTR(TRIM(D.ADMIT_TYPE_GRP), 1, 26)     ADMIT_TYPE_GRP_2,
  ...
  FROM  CSMRT_OWNER.PS_D_ADMIT_TYPE D
