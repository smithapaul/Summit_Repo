CREATE MATERIALIZED VIEW UM_F_SAA_RES_CRSEAVL_MV
NOCACHE
NOLOGGING
COMPRESS BASIC
NOPARALLEL
...
SELECT /*+ parallel(8) */
 ...
 WHERE UM_F_SAA_ADB_RESULTS.EMPLID = UM_F_SAA_ADB_CRSEAVL.EMPLID
   AND UM_F_SAA_ADB_RESULTS.ANALYSIS_DB_SEQ = UM_F_SAA_ADB_CRSEAVL.ANALYSIS_DB_SEQ
   AND UM_F_SAA_ADB_RESULTS.SAA_CAREER_RPT = UM_F_SAA_ADB_CRSEAVL.SAA_CAREER_RPT
   AND UM_F_SAA_ADB_RESULTS.SAA_ENTRY_SEQ = UM_F_SAA_ADB_CRSEAVL.SAA_ENTRY_SEQ
