DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_ACADEMICLEVELBOTCODE
/

--
-- IRENRLCNFRMD_ACADEMICLEVELBOTCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_ACADEMICLEVELBOTCODE ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
