DROP INDEX DLMRT_OWNER.IRENRLPRLM_PRIMARYCOLLEGECODE
/

--
-- IRENRLPRLM_PRIMARYCOLLEGECODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_PRIMARYCOLLEGECODE ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
