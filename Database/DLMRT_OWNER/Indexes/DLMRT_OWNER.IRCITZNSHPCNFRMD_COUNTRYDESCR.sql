DROP INDEX DLMRT_OWNER.IRCITZNSHPCNFRMD_COUNTRYDESCR
/

--
-- IRCITZNSHPCNFRMD_COUNTRYDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRCITZNSHPCNFRMD_COUNTRYDESCR ON DLMRT_OWNER.IR_CITIZENSHIP_DTL_CONFIRMED
(COUNTRY_DESCR)
  LOCAL (  
