DROP INDEX DLMRT_OWNER.IRENRLPRLM_EXPECTEDGRADTERMDESCR
/

--
-- IRENRLPRLM_EXPECTEDGRADTERMDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_EXPECTEDGRADTERMDESCR ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
