DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_PRIMARYMAJORCIPCODE
/

--
-- IRENRLCNFRMD_PRIMARYMAJORCIPCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_PRIMARYMAJORCIPCODE ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
