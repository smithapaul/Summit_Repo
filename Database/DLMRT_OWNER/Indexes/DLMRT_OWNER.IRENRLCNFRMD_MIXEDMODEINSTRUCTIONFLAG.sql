DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_MIXEDMODEINSTRUCTIONFLAG
/

--
-- IRENRLCNFRMD_MIXEDMODEINSTRUCTIONFLAG  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_MIXEDMODEINSTRUCTIONFLAG ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
