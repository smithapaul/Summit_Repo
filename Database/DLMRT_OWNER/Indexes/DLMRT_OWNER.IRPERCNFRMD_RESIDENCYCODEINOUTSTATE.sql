DROP INDEX DLMRT_OWNER.IRPERCNFRMD_RESIDENCYCODEINOUTSTATE
/

--
-- IRPERCNFRMD_RESIDENCYCODEINOUTSTATE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERCNFRMD_RESIDENCYCODEINOUTSTATE ON DLMRT_OWNER.IR_PERSON_CONFIRMED
