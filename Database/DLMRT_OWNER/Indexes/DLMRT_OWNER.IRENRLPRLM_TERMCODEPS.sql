DROP INDEX DLMRT_OWNER.IRENRLPRLM_TERMCODEPS
/

--
-- IRENRLPRLM_TERMCODEPS  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_TERMCODEPS ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
(TERM_CODE_PS)
  LOCAL (  
