DROP INDEX DLMRT_OWNER.IRCITZNSHPPRLM_CITIZENSHIPCODE
/

--
-- IRCITZNSHPPRLM_CITIZENSHIPCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRCITZNSHPPRLM_CITIZENSHIPCODE ON DLMRT_OWNER.IR_CITIZENSHIP_DTL_PRELIM
(CITIZENSHIP_CODE)
  LOCAL (  
