DROP INDEX DLMRT_OWNER.IRENRLPRLM_CENSUSPERIOD
/

--
-- IRENRLPRLM_CENSUSPERIOD  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_CENSUSPERIOD ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
(CENSUS_PERIOD)
  LOCAL (  
