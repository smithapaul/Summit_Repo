DROP INDEX DLMRT_OWNER.IRENRLPRLM_ONLINEONLYSTUDENTFLAG
/

--
-- IRENRLPRLM_ONLINEONLYSTUDENTFLAG  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_ONLINEONLYSTUDENTFLAG ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
