DROP INDEX DLMRT_OWNER.IRPERCNFRMD_RESIDENCYDESCINOUTSTATE
/

--
-- IRPERCNFRMD_RESIDENCYDESCINOUTSTATE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERCNFRMD_RESIDENCYDESCINOUTSTATE ON DLMRT_OWNER.IR_PERSON_CONFIRMED
