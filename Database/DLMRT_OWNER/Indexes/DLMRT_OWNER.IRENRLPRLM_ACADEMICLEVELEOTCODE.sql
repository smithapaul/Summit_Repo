DROP INDEX DLMRT_OWNER.IRENRLPRLM_ACADEMICLEVELEOTCODE
/

--
-- IRENRLPRLM_ACADEMICLEVELEOTCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_ACADEMICLEVELEOTCODE ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
