DROP INDEX DLMRT_OWNER.IRENRLPRLM_ACADEMICLEVELBOTCODE
/

--
-- IRENRLPRLM_ACADEMICLEVELBOTCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_ACADEMICLEVELBOTCODE ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
