DROP INDEX DLMRT_OWNER.IRPERPRLM_COUNTRY2CHARPERMADDRESS
/

--
-- IRPERPRLM_COUNTRY2CHARPERMADDRESS  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_COUNTRY2CHARPERMADDRESS ON DLMRT_OWNER.IR_PERSON_PRELIM
