DROP INDEX DLMRT_OWNER.IRENRLPRLM_FTPTDESCR
/

--
-- IRENRLPRLM_FTPTDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_FTPTDESCR ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
(FT_PT_DESCR)
  LOCAL (  
