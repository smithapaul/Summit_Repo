DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_PRIMARYMAJORSUBPLANTYPE
/

--
-- IRENRLCNFRMD_PRIMARYMAJORSUBPLANTYPE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_PRIMARYMAJORSUBPLANTYPE ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
