DROP INDEX DLMRT_OWNER.IRPERCNFRMD_STATEETHNICITYDESCR
/

--
-- IRPERCNFRMD_STATEETHNICITYDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERCNFRMD_STATEETHNICITYDESCR ON DLMRT_OWNER.IR_PERSON_CONFIRMED
