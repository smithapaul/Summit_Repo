DROP INDEX DLMRT_OWNER.IRPERCNFRMD_RESIDENCYDESCSATUITION
/

--
-- IRPERCNFRMD_RESIDENCYDESCSATUITION  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERCNFRMD_RESIDENCYDESCSATUITION ON DLMRT_OWNER.IR_PERSON_CONFIRMED
