DROP INDEX DLMRT_OWNER.IRENRLPRLM_ACADEMICLEVELEOTDESCR
/

--
-- IRENRLPRLM_ACADEMICLEVELEOTDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_ACADEMICLEVELEOTDESCR ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
