DROP INDEX DLMRT_OWNER.IRCITZNSHPPRLM_CITIZENSHIPSTATUS
/

--
-- IRCITZNSHPPRLM_CITIZENSHIPSTATUS  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRCITZNSHPPRLM_CITIZENSHIPSTATUS ON DLMRT_OWNER.IR_CITIZENSHIP_DTL_PRELIM
(CITIZENSHIP_STATUS)
  LOCAL (  
