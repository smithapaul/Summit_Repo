DROP INDEX DLMRT_OWNER.IRENRLPRLM_PRIMARYMAJORSUBPLANTYPE
/

--
-- IRENRLPRLM_PRIMARYMAJORSUBPLANTYPE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_PRIMARYMAJORSUBPLANTYPE ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
