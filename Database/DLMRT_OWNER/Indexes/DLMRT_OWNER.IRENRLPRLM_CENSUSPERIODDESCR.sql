DROP INDEX DLMRT_OWNER.IRENRLPRLM_CENSUSPERIODDESCR
/

--
-- IRENRLPRLM_CENSUSPERIODDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_CENSUSPERIODDESCR ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
(CENSUS_PERIOD_DESCR)
  LOCAL (  
