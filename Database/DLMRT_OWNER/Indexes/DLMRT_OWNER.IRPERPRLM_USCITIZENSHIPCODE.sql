DROP INDEX DLMRT_OWNER.IRPERPRLM_USCITIZENSHIPCODE
/

--
-- IRPERPRLM_USCITIZENSHIPCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_USCITIZENSHIPCODE ON DLMRT_OWNER.IR_PERSON_PRELIM
(US_CITIZENSHIP_CODE)
  LOCAL (  
