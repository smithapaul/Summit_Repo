DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_PRIMARYCOLLEGEDESCR
/

--
-- IRENRLCNFRMD_PRIMARYCOLLEGEDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_PRIMARYCOLLEGEDESCR ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
