DROP INDEX DLMRT_OWNER.IRPERPRLM_STATEETHNICITYDESCR
/

--
-- IRPERPRLM_STATEETHNICITYDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_STATEETHNICITYDESCR ON DLMRT_OWNER.IR_PERSON_PRELIM
