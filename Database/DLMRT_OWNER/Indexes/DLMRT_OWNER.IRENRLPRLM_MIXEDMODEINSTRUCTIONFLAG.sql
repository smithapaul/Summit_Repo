DROP INDEX DLMRT_OWNER.IRENRLPRLM_MIXEDMODEINSTRUCTIONFLAG
/

--
-- IRENRLPRLM_MIXEDMODEINSTRUCTIONFLAG  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_MIXEDMODEINSTRUCTIONFLAG ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
