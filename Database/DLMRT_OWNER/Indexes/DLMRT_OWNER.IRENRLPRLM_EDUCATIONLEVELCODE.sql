DROP INDEX DLMRT_OWNER.IRENRLPRLM_EDUCATIONLEVELCODE
/

--
-- IRENRLPRLM_EDUCATIONLEVELCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_EDUCATIONLEVELCODE ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
