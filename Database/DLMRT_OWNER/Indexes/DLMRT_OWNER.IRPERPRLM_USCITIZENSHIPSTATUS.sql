DROP INDEX DLMRT_OWNER.IRPERPRLM_USCITIZENSHIPSTATUS
/

--
-- IRPERPRLM_USCITIZENSHIPSTATUS  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_USCITIZENSHIPSTATUS ON DLMRT_OWNER.IR_PERSON_PRELIM
