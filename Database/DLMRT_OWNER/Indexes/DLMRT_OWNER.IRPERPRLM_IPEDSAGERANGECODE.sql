DROP INDEX DLMRT_OWNER.IRPERPRLM_IPEDSAGERANGECODE
/

--
-- IRPERPRLM_IPEDSAGERANGECODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_IPEDSAGERANGECODE ON DLMRT_OWNER.IR_PERSON_PRELIM
