DROP INDEX DLMRT_OWNER.IRPERCNFRMD_RESIDENCYCODETUITION
/

--
-- IRPERCNFRMD_RESIDENCYCODETUITION  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERCNFRMD_RESIDENCYCODETUITION ON DLMRT_OWNER.IR_PERSON_CONFIRMED
