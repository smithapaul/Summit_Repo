DROP INDEX DLMRT_OWNER.IRPERPRLM_COUNTRYDESCRPERMADDRESS
/

--
-- IRPERPRLM_COUNTRYDESCRPERMADDRESS  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_COUNTRYDESCRPERMADDRESS ON DLMRT_OWNER.IR_PERSON_PRELIM
