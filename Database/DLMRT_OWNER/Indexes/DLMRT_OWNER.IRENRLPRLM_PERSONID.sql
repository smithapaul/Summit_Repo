DROP INDEX DLMRT_OWNER.IRENRLPRLM_PERSONID
/

--
-- IRENRLPRLM_PERSONID  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_PERSONID ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
(PERSON_ID)
  LOCAL (  
