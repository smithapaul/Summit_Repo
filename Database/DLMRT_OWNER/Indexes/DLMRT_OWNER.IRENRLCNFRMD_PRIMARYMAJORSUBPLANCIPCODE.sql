DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_PRIMARYMAJORSUBPLANCIPCODE
/

--
-- IRENRLCNFRMD_PRIMARYMAJORSUBPLANCIPCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_PRIMARYMAJORSUBPLANCIPCODE ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
