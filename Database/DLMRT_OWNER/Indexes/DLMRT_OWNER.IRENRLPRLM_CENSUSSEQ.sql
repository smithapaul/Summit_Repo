DROP INDEX DLMRT_OWNER.IRENRLPRLM_CENSUSSEQ
/

--
-- IRENRLPRLM_CENSUSSEQ  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_CENSUSSEQ ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
(CENSUS_SEQ)
  LOCAL (  
