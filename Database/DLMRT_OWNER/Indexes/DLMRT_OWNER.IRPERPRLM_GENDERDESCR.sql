DROP INDEX DLMRT_OWNER.IRPERPRLM_GENDERDESCR
/

--
-- IRPERPRLM_GENDERDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_GENDERDESCR ON DLMRT_OWNER.IR_PERSON_PRELIM
(GENDER_DESCR)
  LOCAL (  
