DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_EXPECTEDGRADTERMDESCR
/

--
-- IRENRLCNFRMD_EXPECTEDGRADTERMDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_EXPECTEDGRADTERMDESCR ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
