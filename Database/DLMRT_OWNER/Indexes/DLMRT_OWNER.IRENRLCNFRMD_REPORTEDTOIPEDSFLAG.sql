DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_REPORTEDTOIPEDSFLAG
/

--
-- IRENRLCNFRMD_REPORTEDTOIPEDSFLAG  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_REPORTEDTOIPEDSFLAG ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
