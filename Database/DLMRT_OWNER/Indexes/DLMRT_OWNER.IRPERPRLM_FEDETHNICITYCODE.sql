DROP INDEX DLMRT_OWNER.IRPERPRLM_FEDETHNICITYCODE
/

--
-- IRPERPRLM_FEDETHNICITYCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_FEDETHNICITYCODE ON DLMRT_OWNER.IR_PERSON_PRELIM
(FED_ETHNICITY_CODE)
  LOCAL (  
