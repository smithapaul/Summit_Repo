DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_ACADEMICLEVELEOTDESCR
/

--
-- IRENRLCNFRMD_ACADEMICLEVELEOTDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_ACADEMICLEVELEOTDESCR ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
