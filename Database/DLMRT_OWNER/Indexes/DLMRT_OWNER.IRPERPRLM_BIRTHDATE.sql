DROP INDEX DLMRT_OWNER.IRPERPRLM_BIRTHDATE
/

--
-- IRPERPRLM_BIRTHDATE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_BIRTHDATE ON DLMRT_OWNER.IR_PERSON_PRELIM
(BIRTH_DATE)
  LOCAL (  
