DROP INDEX DLMRT_OWNER.IRENRLPRLM_PRIMARYCOLLEGEDESCR
/

--
-- IRENRLPRLM_PRIMARYCOLLEGEDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_PRIMARYCOLLEGEDESCR ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
