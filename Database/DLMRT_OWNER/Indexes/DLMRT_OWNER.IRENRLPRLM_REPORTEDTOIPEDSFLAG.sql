DROP INDEX DLMRT_OWNER.IRENRLPRLM_REPORTEDTOIPEDSFLAG
/

--
-- IRENRLPRLM_REPORTEDTOIPEDSFLAG  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_REPORTEDTOIPEDSFLAG ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
