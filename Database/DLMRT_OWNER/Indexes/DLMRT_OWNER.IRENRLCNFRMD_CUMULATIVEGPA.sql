DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_CUMULATIVEGPA
/

--
-- IRENRLCNFRMD_CUMULATIVEGPA  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_CUMULATIVEGPA ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
(CUMULATIVE_GPA)
  LOCAL (  
