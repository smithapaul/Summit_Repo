DROP INDEX DLMRT_OWNER.IRPERCNFRMD_STATEETHNICITYCODE
/

--
-- IRPERCNFRMD_STATEETHNICITYCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERCNFRMD_STATEETHNICITYCODE ON DLMRT_OWNER.IR_PERSON_CONFIRMED
