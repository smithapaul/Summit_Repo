DROP INDEX DLMRT_OWNER.IRENRLPRLM_ADMITTYPE
/

--
-- IRENRLPRLM_ADMITTYPE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_ADMITTYPE ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
(ADMIT_TYPE)
  LOCAL (  
