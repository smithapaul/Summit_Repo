DROP INDEX DLMRT_OWNER.IRCITZNSHPPRLM_COUNTRYDESCR
/

--
-- IRCITZNSHPPRLM_COUNTRYDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRCITZNSHPPRLM_COUNTRYDESCR ON DLMRT_OWNER.IR_CITIZENSHIP_DTL_PRELIM
(COUNTRY_DESCR)
  LOCAL (  
