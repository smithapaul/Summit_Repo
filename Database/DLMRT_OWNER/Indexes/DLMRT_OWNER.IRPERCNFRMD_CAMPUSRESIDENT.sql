DROP INDEX DLMRT_OWNER.IRPERCNFRMD_CAMPUSRESIDENT
/

--
-- IRPERCNFRMD_CAMPUSRESIDENT  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERCNFRMD_CAMPUSRESIDENT ON DLMRT_OWNER.IR_PERSON_CONFIRMED
(CAMPUS_RESIDENT)
  LOCAL (  
