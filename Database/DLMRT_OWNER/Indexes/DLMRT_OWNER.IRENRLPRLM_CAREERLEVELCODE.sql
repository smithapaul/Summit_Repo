DROP INDEX DLMRT_OWNER.IRENRLPRLM_CAREERLEVELCODE
/

--
-- IRENRLPRLM_CAREERLEVELCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_CAREERLEVELCODE ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
(CAREER_LEVEL_CODE)
  LOCAL (  
