DROP INDEX DLMRT_OWNER.IRPERPRLM_FEDETHNICITYDESCR
/

--
-- IRPERPRLM_FEDETHNICITYDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_FEDETHNICITYDESCR ON DLMRT_OWNER.IR_PERSON_PRELIM
(FED_ETHNICITY_DESCR)
  LOCAL (  
