DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_ACADEMICLEVELEOTCODE
/

--
-- IRENRLCNFRMD_ACADEMICLEVELEOTCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_ACADEMICLEVELEOTCODE ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
