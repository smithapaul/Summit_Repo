DROP INDEX DLMRT_OWNER.IRPERPRLM_UNDERREPRESENTEDMINORITY
/

--
-- IRPERPRLM_UNDERREPRESENTEDMINORITY  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_UNDERREPRESENTEDMINORITY ON DLMRT_OWNER.IR_PERSON_PRELIM
