DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_EDUCATIONLEVELCODE
/

--
-- IRENRLCNFRMD_EDUCATIONLEVELCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_EDUCATIONLEVELCODE ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
