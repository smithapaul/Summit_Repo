DROP INDEX DLMRT_OWNER.IRPERCNFRMD_PERSONID
/

--
-- IRPERCNFRMD_PERSONID  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERCNFRMD_PERSONID ON DLMRT_OWNER.IR_PERSON_CONFIRMED
(PERSON_ID)
  LOCAL (  
