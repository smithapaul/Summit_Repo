DROP INDEX DLMRT_OWNER.IRPERCNFRMD_FEDETHNICITYDESCR
/

--
-- IRPERCNFRMD_FEDETHNICITYDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERCNFRMD_FEDETHNICITYDESCR ON DLMRT_OWNER.IR_PERSON_CONFIRMED
(FED_ETHNICITY_DESCR)
  LOCAL (  
