DROP INDEX DLMRT_OWNER.IRPERCNFRMD_COUNTRYDESCRNONUS
/

--
-- IRPERCNFRMD_COUNTRYDESCRNONUS  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERCNFRMD_COUNTRYDESCRNONUS ON DLMRT_OWNER.IR_PERSON_CONFIRMED
