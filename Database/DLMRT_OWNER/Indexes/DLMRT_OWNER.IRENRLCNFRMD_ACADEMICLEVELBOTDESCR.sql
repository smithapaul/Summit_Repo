DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_ACADEMICLEVELBOTDESCR
/

--
-- IRENRLCNFRMD_ACADEMICLEVELBOTDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_ACADEMICLEVELBOTDESCR ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
