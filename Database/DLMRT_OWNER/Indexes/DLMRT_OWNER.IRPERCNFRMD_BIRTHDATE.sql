DROP INDEX DLMRT_OWNER.IRPERCNFRMD_BIRTHDATE
/

--
-- IRPERCNFRMD_BIRTHDATE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERCNFRMD_BIRTHDATE ON DLMRT_OWNER.IR_PERSON_CONFIRMED
(BIRTH_DATE)
  LOCAL (  
