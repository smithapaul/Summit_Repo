DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_ADMITTERMDESCR
/

--
-- IRENRLCNFRMD_ADMITTERMDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_ADMITTERMDESCR ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
(ADMIT_TERM_DESCR)
  LOCAL (  
