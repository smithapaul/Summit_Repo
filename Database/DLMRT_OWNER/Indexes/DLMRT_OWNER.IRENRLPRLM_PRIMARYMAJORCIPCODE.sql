DROP INDEX DLMRT_OWNER.IRENRLPRLM_PRIMARYMAJORCIPCODE
/

--
-- IRENRLPRLM_PRIMARYMAJORCIPCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_PRIMARYMAJORCIPCODE ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
