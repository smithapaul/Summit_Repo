DROP INDEX DLMRT_OWNER.IRPERCNFRMD_IPEDSAGERANGEDESCR
/

--
-- IRPERCNFRMD_IPEDSAGERANGEDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERCNFRMD_IPEDSAGERANGEDESCR ON DLMRT_OWNER.IR_PERSON_CONFIRMED
