DROP INDEX DLMRT_OWNER.IRENRLPRLM_EXPECTEDGRADTERMCODE
/

--
-- IRENRLPRLM_EXPECTEDGRADTERMCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_EXPECTEDGRADTERMCODE ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
