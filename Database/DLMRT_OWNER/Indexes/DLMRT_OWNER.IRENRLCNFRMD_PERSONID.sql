DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_PERSONID
/

--
-- IRENRLCNFRMD_PERSONID  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_PERSONID ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
(PERSON_ID)
  LOCAL (  
