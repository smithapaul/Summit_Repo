DROP INDEX DLMRT_OWNER.IRENRLPRLM_ACADEMICLEVELBOTDESCR
/

--
-- IRENRLPRLM_ACADEMICLEVELBOTDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_ACADEMICLEVELBOTDESCR ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
