DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_CAREERLEVELCODE
/

--
-- IRENRLCNFRMD_CAREERLEVELCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_CAREERLEVELCODE ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
(CAREER_LEVEL_CODE)
  LOCAL (  
