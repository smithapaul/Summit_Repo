DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_PROGRAMTYPE
/

--
-- IRENRLCNFRMD_PROGRAMTYPE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_PROGRAMTYPE ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
(PROGRAM_TYPE)
  LOCAL (  
