DROP INDEX DLMRT_OWNER.IRENRLPRLM_DOCTORATETYPECODE
/

--
-- IRENRLPRLM_DOCTORATETYPECODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_DOCTORATETYPECODE ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
(DOCTORATE_TYPE_CODE)
  LOCAL (  
