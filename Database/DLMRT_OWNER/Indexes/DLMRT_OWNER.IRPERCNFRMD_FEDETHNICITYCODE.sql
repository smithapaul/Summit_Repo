DROP INDEX DLMRT_OWNER.IRPERCNFRMD_FEDETHNICITYCODE
/

--
-- IRPERCNFRMD_FEDETHNICITYCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERCNFRMD_FEDETHNICITYCODE ON DLMRT_OWNER.IR_PERSON_CONFIRMED
(FED_ETHNICITY_CODE)
  LOCAL (  
