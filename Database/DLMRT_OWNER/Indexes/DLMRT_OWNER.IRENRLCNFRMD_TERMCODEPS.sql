DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_TERMCODEPS
/

--
-- IRENRLCNFRMD_TERMCODEPS  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_TERMCODEPS ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
(TERM_CODE_PS)
  LOCAL (  
