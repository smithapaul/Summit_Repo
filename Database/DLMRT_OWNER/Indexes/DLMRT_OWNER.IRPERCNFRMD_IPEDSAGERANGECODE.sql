DROP INDEX DLMRT_OWNER.IRPERCNFRMD_IPEDSAGERANGECODE
/

--
-- IRPERCNFRMD_IPEDSAGERANGECODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERCNFRMD_IPEDSAGERANGECODE ON DLMRT_OWNER.IR_PERSON_CONFIRMED
