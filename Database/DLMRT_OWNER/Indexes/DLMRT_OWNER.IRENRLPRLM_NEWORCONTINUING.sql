DROP INDEX DLMRT_OWNER.IRENRLPRLM_NEWORCONTINUING
/

--
-- IRENRLPRLM_NEWORCONTINUING  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_NEWORCONTINUING ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
(NEW_OR_CONTINUING)
  LOCAL (  
