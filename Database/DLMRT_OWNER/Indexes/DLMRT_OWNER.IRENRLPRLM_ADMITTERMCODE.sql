DROP INDEX DLMRT_OWNER.IRENRLPRLM_ADMITTERMCODE
/

--
-- IRENRLPRLM_ADMITTERMCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_ADMITTERMCODE ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
(ADMIT_TERM_CODE)
  LOCAL (  
