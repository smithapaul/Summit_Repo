DROP INDEX DLMRT_OWNER.IRENRLPRLM_PELLRECIPIENTFLAG
/

--
-- IRENRLPRLM_PELLRECIPIENTFLAG  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_PELLRECIPIENTFLAG ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
(PELL_RECIPIENT_FLAG)
  LOCAL (  
