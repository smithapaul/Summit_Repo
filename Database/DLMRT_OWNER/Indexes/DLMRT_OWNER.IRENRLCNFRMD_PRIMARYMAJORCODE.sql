DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_PRIMARYMAJORCODE
/

--
-- IRENRLCNFRMD_PRIMARYMAJORCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_PRIMARYMAJORCODE ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
(PRIMARY_MAJOR_CODE)
  LOCAL (  
