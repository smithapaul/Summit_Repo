DROP INDEX DLMRT_OWNER.IRENRLPRLM_ACADEMICCAREERPS
/

--
-- IRENRLPRLM_ACADEMICCAREERPS  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_ACADEMICCAREERPS ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
(ACADEMIC_CAREER_PS)
  LOCAL (  
