DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_PRIMARYMAJORDESCR
/

--
-- IRENRLCNFRMD_PRIMARYMAJORDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_PRIMARYMAJORDESCR ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
(PRIMARY_MAJOR_DESCR)
  LOCAL (  
