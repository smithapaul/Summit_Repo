DROP INDEX DLMRT_OWNER.IRCITZNSHPPRLM_PERSONID
/

--
-- IRCITZNSHPPRLM_PERSONID  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRCITZNSHPPRLM_PERSONID ON DLMRT_OWNER.IR_CITIZENSHIP_DTL_PRELIM
(PERSON_ID)
  LOCAL (  
