DROP INDEX DLMRT_OWNER.IRPERPRLM_CAMPUSRESIDENT
/

--
-- IRPERPRLM_CAMPUSRESIDENT  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_CAMPUSRESIDENT ON DLMRT_OWNER.IR_PERSON_PRELIM
(CAMPUS_RESIDENT)
  LOCAL (  
