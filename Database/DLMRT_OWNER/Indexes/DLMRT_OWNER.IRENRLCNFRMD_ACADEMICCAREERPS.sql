DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_ACADEMICCAREERPS
/

--
-- IRENRLCNFRMD_ACADEMICCAREERPS  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_ACADEMICCAREERPS ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
(ACADEMIC_CAREER_PS)
  LOCAL (  
