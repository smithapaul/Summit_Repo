DROP INDEX DLMRT_OWNER.IRPERCNFRMD_GENDERDESCR
/

--
-- IRPERCNFRMD_GENDERDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERCNFRMD_GENDERDESCR ON DLMRT_OWNER.IR_PERSON_CONFIRMED
(GENDER_DESCR)
  LOCAL (  
