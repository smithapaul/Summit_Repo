DROP INDEX DLMRT_OWNER.IRENRLPRLM_CESSTUDENTFLAG
/

--
-- IRENRLPRLM_CESSTUDENTFLAG  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_CESSTUDENTFLAG ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
(CES_STUDENT_FLAG)
  LOCAL (  
