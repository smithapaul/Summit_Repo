DROP INDEX DLMRT_OWNER.IRENRLPRLM_PRIMARYMAJORSUBPLANCODE
/

--
-- IRENRLPRLM_PRIMARYMAJORSUBPLANCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_PRIMARYMAJORSUBPLANCODE ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
