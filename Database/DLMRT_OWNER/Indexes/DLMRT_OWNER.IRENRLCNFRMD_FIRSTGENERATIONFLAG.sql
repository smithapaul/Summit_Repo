DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_FIRSTGENERATIONFLAG
/

--
-- IRENRLCNFRMD_FIRSTGENERATIONFLAG  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_FIRSTGENERATIONFLAG ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
