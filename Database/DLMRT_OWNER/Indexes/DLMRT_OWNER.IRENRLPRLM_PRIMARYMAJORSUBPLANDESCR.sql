DROP INDEX DLMRT_OWNER.IRENRLPRLM_PRIMARYMAJORSUBPLANDESCR
/

--
-- IRENRLPRLM_PRIMARYMAJORSUBPLANDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_PRIMARYMAJORSUBPLANDESCR ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
