DROP INDEX DLMRT_OWNER.IRPERCNFRMD_GENDERCODE
/

--
-- IRPERCNFRMD_GENDERCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERCNFRMD_GENDERCODE ON DLMRT_OWNER.IR_PERSON_CONFIRMED
(GENDER_CODE)
  LOCAL (  
