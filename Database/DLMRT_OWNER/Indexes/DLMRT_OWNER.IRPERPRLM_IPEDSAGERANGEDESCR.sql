DROP INDEX DLMRT_OWNER.IRPERPRLM_IPEDSAGERANGEDESCR
/

--
-- IRPERPRLM_IPEDSAGERANGEDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_IPEDSAGERANGEDESCR ON DLMRT_OWNER.IR_PERSON_PRELIM
