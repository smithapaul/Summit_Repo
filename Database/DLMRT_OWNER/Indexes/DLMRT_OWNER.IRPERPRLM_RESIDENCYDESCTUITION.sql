DROP INDEX DLMRT_OWNER.IRPERPRLM_RESIDENCYDESCTUITION
/

--
-- IRPERPRLM_RESIDENCYDESCTUITION  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_RESIDENCYDESCTUITION ON DLMRT_OWNER.IR_PERSON_PRELIM
