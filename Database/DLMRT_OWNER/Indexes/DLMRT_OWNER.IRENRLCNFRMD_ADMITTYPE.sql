DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_ADMITTYPE
/

--
-- IRENRLCNFRMD_ADMITTYPE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_ADMITTYPE ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
(ADMIT_TYPE)
  LOCAL (  
