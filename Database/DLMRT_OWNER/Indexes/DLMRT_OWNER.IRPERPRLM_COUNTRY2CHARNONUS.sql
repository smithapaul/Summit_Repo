DROP INDEX DLMRT_OWNER.IRPERPRLM_COUNTRY2CHARNONUS
/

--
-- IRPERPRLM_COUNTRY2CHARNONUS  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_COUNTRY2CHARNONUS ON DLMRT_OWNER.IR_PERSON_PRELIM
