DROP INDEX DLMRT_OWNER.IRPERCNFRMD_USCITIZENSHIPCODE
/

--
-- IRPERCNFRMD_USCITIZENSHIPCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERCNFRMD_USCITIZENSHIPCODE ON DLMRT_OWNER.IR_PERSON_CONFIRMED
(US_CITIZENSHIP_CODE)
  LOCAL (  
