DROP INDEX DLMRT_OWNER.IRPERCNFRMD_COUNTRY2CHARPERMADDRESS
/

--
-- IRPERCNFRMD_COUNTRY2CHARPERMADDRESS  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERCNFRMD_COUNTRY2CHARPERMADDRESS ON DLMRT_OWNER.IR_PERSON_CONFIRMED
