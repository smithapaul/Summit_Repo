DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_CUMULATIVECREDITS
/

--
-- IRENRLCNFRMD_CUMULATIVECREDITS  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_CUMULATIVECREDITS ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
(CUMULATIVE_CREDITS)
  LOCAL (  
