DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_PRIMARYMAJORPLANTYPE
/

--
-- IRENRLCNFRMD_PRIMARYMAJORPLANTYPE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_PRIMARYMAJORPLANTYPE ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
