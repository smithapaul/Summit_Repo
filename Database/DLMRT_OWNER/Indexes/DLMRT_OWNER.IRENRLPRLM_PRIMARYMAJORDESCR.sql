DROP INDEX DLMRT_OWNER.IRENRLPRLM_PRIMARYMAJORDESCR
/

--
-- IRENRLPRLM_PRIMARYMAJORDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_PRIMARYMAJORDESCR ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
(PRIMARY_MAJOR_DESCR)
  LOCAL (  
