DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_EXPECTEDGRADTERMCODE
/

--
-- IRENRLCNFRMD_EXPECTEDGRADTERMCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_EXPECTEDGRADTERMCODE ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
