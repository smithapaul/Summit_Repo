DROP INDEX DLMRT_OWNER.IRCITZNSHPCNFRMD_PERSONID
/

--
-- IRCITZNSHPCNFRMD_PERSONID  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRCITZNSHPCNFRMD_PERSONID ON DLMRT_OWNER.IR_CITIZENSHIP_DTL_CONFIRMED
(PERSON_ID)
  LOCAL (  
