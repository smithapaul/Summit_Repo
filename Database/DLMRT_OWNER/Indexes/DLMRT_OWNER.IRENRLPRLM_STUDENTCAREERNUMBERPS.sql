DROP INDEX DLMRT_OWNER.IRENRLPRLM_STUDENTCAREERNUMBERPS
/

--
-- IRENRLPRLM_STUDENTCAREERNUMBERPS  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_STUDENTCAREERNUMBERPS ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
