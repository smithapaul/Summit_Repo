DROP INDEX DLMRT_OWNER.IRCITZNSHPCNFRMD_COUNTRY2CHAR
/

--
-- IRCITZNSHPCNFRMD_COUNTRY2CHAR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRCITZNSHPCNFRMD_COUNTRY2CHAR ON DLMRT_OWNER.IR_CITIZENSHIP_DTL_CONFIRMED
(COUNTRY_2CHAR)
  LOCAL (  
