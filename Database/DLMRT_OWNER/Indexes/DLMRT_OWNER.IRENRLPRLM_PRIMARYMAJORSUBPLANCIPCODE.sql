DROP INDEX DLMRT_OWNER.IRENRLPRLM_PRIMARYMAJORSUBPLANCIPCODE
/

--
-- IRENRLPRLM_PRIMARYMAJORSUBPLANCIPCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_PRIMARYMAJORSUBPLANCIPCODE ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
