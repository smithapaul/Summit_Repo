DROP INDEX DLMRT_OWNER.IRPERPRLM_STATEETHNICITYCODE
/

--
-- IRPERPRLM_STATEETHNICITYCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_STATEETHNICITYCODE ON DLMRT_OWNER.IR_PERSON_PRELIM
