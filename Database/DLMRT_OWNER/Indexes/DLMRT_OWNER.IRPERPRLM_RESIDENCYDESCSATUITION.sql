DROP INDEX DLMRT_OWNER.IRPERPRLM_RESIDENCYDESCSATUITION
/

--
-- IRPERPRLM_RESIDENCYDESCSATUITION  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_RESIDENCYDESCSATUITION ON DLMRT_OWNER.IR_PERSON_PRELIM
