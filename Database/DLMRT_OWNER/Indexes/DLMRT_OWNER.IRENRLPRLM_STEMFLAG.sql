DROP INDEX DLMRT_OWNER.IRENRLPRLM_STEMFLAG
/

--
-- IRENRLPRLM_STEMFLAG  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_STEMFLAG ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
(STEM_FLAG)
  LOCAL (  
