DROP INDEX DLMRT_OWNER.IRPERCNFRMD_UNDERREPRESENTEDMINORITY
/

--
-- IRPERCNFRMD_UNDERREPRESENTEDMINORITY  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERCNFRMD_UNDERREPRESENTEDMINORITY ON DLMRT_OWNER.IR_PERSON_CONFIRMED
