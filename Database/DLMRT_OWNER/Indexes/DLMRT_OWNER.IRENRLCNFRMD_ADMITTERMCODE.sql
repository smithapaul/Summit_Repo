DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_ADMITTERMCODE
/

--
-- IRENRLCNFRMD_ADMITTERMCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_ADMITTERMCODE ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
(ADMIT_TERM_CODE)
  LOCAL (  
