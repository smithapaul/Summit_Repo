DROP INDEX DLMRT_OWNER.IRCITZNSHPCNFRMD_CITIZENSHIPCODE
/

--
-- IRCITZNSHPCNFRMD_CITIZENSHIPCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRCITZNSHPCNFRMD_CITIZENSHIPCODE ON DLMRT_OWNER.IR_CITIZENSHIP_DTL_CONFIRMED
(CITIZENSHIP_CODE)
  LOCAL (  
