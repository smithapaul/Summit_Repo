DROP INDEX DLMRT_OWNER.IRPERCNFRMD_RESIDENCYDESCTUITION
/

--
-- IRPERCNFRMD_RESIDENCYDESCTUITION  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERCNFRMD_RESIDENCYDESCTUITION ON DLMRT_OWNER.IR_PERSON_CONFIRMED
