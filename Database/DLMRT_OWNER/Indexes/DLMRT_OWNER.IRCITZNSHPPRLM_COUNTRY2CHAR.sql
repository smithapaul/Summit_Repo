DROP INDEX DLMRT_OWNER.IRCITZNSHPPRLM_COUNTRY2CHAR
/

--
-- IRCITZNSHPPRLM_COUNTRY2CHAR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRCITZNSHPPRLM_COUNTRY2CHAR ON DLMRT_OWNER.IR_CITIZENSHIP_DTL_PRELIM
(COUNTRY_2CHAR)
  LOCAL (  
