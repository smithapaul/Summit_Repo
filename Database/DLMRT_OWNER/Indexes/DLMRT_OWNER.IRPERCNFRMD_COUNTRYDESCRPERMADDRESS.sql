DROP INDEX DLMRT_OWNER.IRPERCNFRMD_COUNTRYDESCRPERMADDRESS
/

--
-- IRPERCNFRMD_COUNTRYDESCRPERMADDRESS  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERCNFRMD_COUNTRYDESCRPERMADDRESS ON DLMRT_OWNER.IR_PERSON_CONFIRMED
