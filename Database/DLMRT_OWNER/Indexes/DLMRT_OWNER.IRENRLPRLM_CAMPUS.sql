DROP INDEX DLMRT_OWNER.IRENRLPRLM_CAMPUS
/

--
-- IRENRLPRLM_CAMPUS  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_CAMPUS ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
(CAMPUS)
  LOCAL (  
