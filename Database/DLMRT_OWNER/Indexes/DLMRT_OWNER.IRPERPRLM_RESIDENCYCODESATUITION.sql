DROP INDEX DLMRT_OWNER.IRPERPRLM_RESIDENCYCODESATUITION
/

--
-- IRPERPRLM_RESIDENCYCODESATUITION  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_RESIDENCYCODESATUITION ON DLMRT_OWNER.IR_PERSON_PRELIM
