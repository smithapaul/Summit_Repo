DROP INDEX DLMRT_OWNER.IRENRLPRLM_FIRSTGENERATIONFLAG
/

--
-- IRENRLPRLM_FIRSTGENERATIONFLAG  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_FIRSTGENERATIONFLAG ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
