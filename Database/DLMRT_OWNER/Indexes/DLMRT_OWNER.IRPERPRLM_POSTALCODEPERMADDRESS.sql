DROP INDEX DLMRT_OWNER.IRPERPRLM_POSTALCODEPERMADDRESS
/

--
-- IRPERPRLM_POSTALCODEPERMADDRESS  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_POSTALCODEPERMADDRESS ON DLMRT_OWNER.IR_PERSON_PRELIM
