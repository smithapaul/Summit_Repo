DROP INDEX DLMRT_OWNER.IRENRLPRLM_PROGRAMTYPE
/

--
-- IRENRLPRLM_PROGRAMTYPE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_PROGRAMTYPE ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
(PROGRAM_TYPE)
  LOCAL (  
