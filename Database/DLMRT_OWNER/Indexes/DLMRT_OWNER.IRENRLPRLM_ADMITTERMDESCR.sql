DROP INDEX DLMRT_OWNER.IRENRLPRLM_ADMITTERMDESCR
/

--
-- IRENRLPRLM_ADMITTERMDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_ADMITTERMDESCR ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
(ADMIT_TERM_DESCR)
  LOCAL (  
