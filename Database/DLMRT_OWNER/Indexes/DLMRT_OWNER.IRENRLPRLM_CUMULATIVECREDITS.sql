DROP INDEX DLMRT_OWNER.IRENRLPRLM_CUMULATIVECREDITS
/

--
-- IRENRLPRLM_CUMULATIVECREDITS  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_CUMULATIVECREDITS ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
(CUMULATIVE_CREDITS)
  LOCAL (  
