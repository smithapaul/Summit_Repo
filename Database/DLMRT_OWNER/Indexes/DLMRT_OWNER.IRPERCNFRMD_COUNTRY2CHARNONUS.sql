DROP INDEX DLMRT_OWNER.IRPERCNFRMD_COUNTRY2CHARNONUS
/

--
-- IRPERCNFRMD_COUNTRY2CHARNONUS  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERCNFRMD_COUNTRY2CHARNONUS ON DLMRT_OWNER.IR_PERSON_CONFIRMED
