DROP INDEX DLMRT_OWNER.IRENRLPRLM_PRIMARYMAJORCODE
/

--
-- IRENRLPRLM_PRIMARYMAJORCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_PRIMARYMAJORCODE ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
(PRIMARY_MAJOR_CODE)
  LOCAL (  
