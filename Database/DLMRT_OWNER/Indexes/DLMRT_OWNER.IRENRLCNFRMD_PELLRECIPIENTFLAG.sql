DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_PELLRECIPIENTFLAG
/

--
-- IRENRLCNFRMD_PELLRECIPIENTFLAG  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_PELLRECIPIENTFLAG ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
(PELL_RECIPIENT_FLAG)
  LOCAL (  
