DROP INDEX DLMRT_OWNER.IRENRLPRLM_FTPTCODE
/

--
-- IRENRLPRLM_FTPTCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_FTPTCODE ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
(FT_PT_CODE)
  LOCAL (  
