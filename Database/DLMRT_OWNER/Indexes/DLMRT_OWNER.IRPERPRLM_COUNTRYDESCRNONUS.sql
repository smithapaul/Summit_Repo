DROP INDEX DLMRT_OWNER.IRPERPRLM_COUNTRYDESCRNONUS
/

--
-- IRPERPRLM_COUNTRYDESCRNONUS  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_COUNTRYDESCRNONUS ON DLMRT_OWNER.IR_PERSON_PRELIM
