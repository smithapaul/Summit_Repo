DROP INDEX DLMRT_OWNER.IRPERPRLM_RESIDENCYCODETUITION
/

--
-- IRPERPRLM_RESIDENCYCODETUITION  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_RESIDENCYCODETUITION ON DLMRT_OWNER.IR_PERSON_PRELIM
