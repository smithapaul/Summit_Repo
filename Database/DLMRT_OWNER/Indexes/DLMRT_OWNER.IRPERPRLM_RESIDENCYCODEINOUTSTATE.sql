DROP INDEX DLMRT_OWNER.IRPERPRLM_RESIDENCYCODEINOUTSTATE
/

--
-- IRPERPRLM_RESIDENCYCODEINOUTSTATE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_RESIDENCYCODEINOUTSTATE ON DLMRT_OWNER.IR_PERSON_PRELIM
