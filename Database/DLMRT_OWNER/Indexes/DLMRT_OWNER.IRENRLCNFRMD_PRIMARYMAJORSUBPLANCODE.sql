DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_PRIMARYMAJORSUBPLANCODE
/

--
-- IRENRLCNFRMD_PRIMARYMAJORSUBPLANCODE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_PRIMARYMAJORSUBPLANCODE ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
