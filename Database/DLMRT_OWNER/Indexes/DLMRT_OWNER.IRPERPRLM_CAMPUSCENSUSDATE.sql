DROP INDEX DLMRT_OWNER.IRPERPRLM_CAMPUSCENSUSDATE
/

--
-- IRPERPRLM_CAMPUSCENSUSDATE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_CAMPUSCENSUSDATE ON DLMRT_OWNER.IR_PERSON_PRELIM
(CAMPUS_CENSUS_DATE)
  LOCAL (  
