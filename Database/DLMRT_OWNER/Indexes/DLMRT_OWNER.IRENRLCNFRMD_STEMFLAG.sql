DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_STEMFLAG
/

--
-- IRENRLCNFRMD_STEMFLAG  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_STEMFLAG ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
(STEM_FLAG)
  LOCAL (  
