DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_NEWORCONTINUING
/

--
-- IRENRLCNFRMD_NEWORCONTINUING  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_NEWORCONTINUING ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
(NEW_OR_CONTINUING)
  LOCAL (  
