DROP INDEX DLMRT_OWNER.IRENRLPRLM_EDUCATIONLEVELDESCR
/

--
-- IRENRLPRLM_EDUCATIONLEVELDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_EDUCATIONLEVELDESCR ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
