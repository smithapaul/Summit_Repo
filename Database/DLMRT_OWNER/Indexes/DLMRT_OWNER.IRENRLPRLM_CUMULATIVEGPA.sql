DROP INDEX DLMRT_OWNER.IRENRLPRLM_CUMULATIVEGPA
/

--
-- IRENRLPRLM_CUMULATIVEGPA  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_CUMULATIVEGPA ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
(CUMULATIVE_GPA)
  LOCAL (  
