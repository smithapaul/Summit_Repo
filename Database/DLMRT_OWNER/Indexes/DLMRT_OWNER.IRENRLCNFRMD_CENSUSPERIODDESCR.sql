DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_CENSUSPERIODDESCR
/

--
-- IRENRLCNFRMD_CENSUSPERIODDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_CENSUSPERIODDESCR ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
(CENSUS_PERIOD_DESCR)
  LOCAL (  
