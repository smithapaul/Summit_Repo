DROP INDEX DLMRT_OWNER.IRENRLCNFRMD_EDUCATIONLEVELDESCR
/

--
-- IRENRLCNFRMD_EDUCATIONLEVELDESCR  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLCNFRMD_EDUCATIONLEVELDESCR ON DLMRT_OWNER.IR_STUDENT_ENROL_CONFIRMED
