DROP INDEX DLMRT_OWNER.IRENRLPRLM_PRIMARYMAJORPLANTYPE
/

--
-- IRENRLPRLM_PRIMARYMAJORPLANTYPE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRENRLPRLM_PRIMARYMAJORPLANTYPE ON DLMRT_OWNER.IR_STUDENT_ENROL_PRELIM
