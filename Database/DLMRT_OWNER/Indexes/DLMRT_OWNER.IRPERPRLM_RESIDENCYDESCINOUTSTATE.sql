DROP INDEX DLMRT_OWNER.IRPERPRLM_RESIDENCYDESCINOUTSTATE
/

--
-- IRPERPRLM_RESIDENCYDESCINOUTSTATE  (Index) 
--
CREATE BITMAP INDEX DLMRT_OWNER.IRPERPRLM_RESIDENCYDESCINOUTSTATE ON DLMRT_OWNER.IR_PERSON_PRELIM
