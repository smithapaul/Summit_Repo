DROP VIEW CSSTG_OWNER.BB_ACTIVITY_TERM_UMLOW_VW
/

--
-- BB_ACTIVITY_TERM_UMLOW_VW  (View) 
--
CREATE OR REPLACE VIEW CSSTG_OWNER.BB_ACTIVITY_TERM_UMLOW_VW
BEQUEATH DEFINER
AS 
with Q1 as (
select /*+ parallel(8) inline no_use_nl(ACT CM U) */
       'UMLOW' AS INSTITUTION_CD,
