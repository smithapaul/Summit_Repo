DROP TABLE CSSTG_OWNER.BB_ACTIVITY_ACCUMULATOR_UMLOW_DAY CASCADE CONSTRAINTS
/

--
-- BB_ACTIVITY_ACCUMULATOR_UMLOW_DAY  (Table) 
--
CREATE TABLE CSSTG_OWNER.BB_ACTIVITY_ACCUMULATOR_UMLOW_DAY
(
