DROP TABLE CSSTG_OWNER.BB_ACTIVITY_ACCUMULATOR_UMDAR CASCADE CONSTRAINTS
/

--
-- BB_ACTIVITY_ACCUMULATOR_UMDAR  (Table) 
--
CREATE TABLE CSSTG_OWNER.BB_ACTIVITY_ACCUMULATOR_UMDAR
(
...
COMMENT ON COLUMN CSSTG_OWNER.BB_ACTIVITY_ACCUMULATOR_UMDAR.GROUP_PK1 IS 'This is a foreign key referencing the primary key of the group table to indicate the Course Group this activity belongs to. This will be NULL if the activity is not Course Group related.'
/
...
COMMENT ON COLUMN CSSTG_OWNER.BB_ACTIVITY_ACCUMULATOR_UMDAR.TIMESTAMP IS 'This is the date and/or time at which this event occurred.'
/

COMMENT ON COLUMN CSSTG_OWNER.BB_ACTIVITY_ACCUMULATOR_UMDAR.STATUS IS 'This indicates the status of the event. Value values are success (1) or failure (0). The values come from the TrackingEvent.Status enumeration.'
/
...
COMMENT ON COLUMN CSSTG_OWNER.BB_ACTIVITY_ACCUMULATOR_UMDAR.DELETE_FLAG IS 'This is a Summit Y/N flag that indicates that this row is no longer in the source data.'
/

COMMENT ON COLUMN CSSTG_OWNER.BB_ACTIVITY_ACCUMULATOR_UMDAR.INSERT_TIME IS 'This is the date and time that this row was inserted into the Summit database.'
/

COMMENT ON COLUMN CSSTG_OWNER.BB_ACTIVITY_ACCUMULATOR_UMDAR.UPDATE_TIME IS 'This is the date and time that this row was last updated in the Summit database.'
/
