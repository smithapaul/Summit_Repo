DROP TABLE CSSTG_OWNER.PS_MILESTONE_TBL_OLD CASCADE CONSTRAINTS
/

--
-- PS_MILESTONE_TBL_OLD  (Table) 
--
CREATE TABLE CSSTG_OWNER.PS_MILESTONE_TBL_OLD
(
  ...
  PRNT_MLSTN_DETL   VARCHAR2(1 BYTE)            NOT NULL,
