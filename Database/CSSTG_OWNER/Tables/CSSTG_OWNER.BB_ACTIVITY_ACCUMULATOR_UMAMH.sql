DROP TABLE CSSTG_OWNER.BB_ACTIVITY_ACCUMULATOR_UMAMH CASCADE CONSTRAINTS
/

--
-- BB_ACTIVITY_ACCUMULATOR_UMAMH  (Table) 
--
CREATE TABLE CSSTG_OWNER.BB_ACTIVITY_ACCUMULATOR_UMAMH
(
