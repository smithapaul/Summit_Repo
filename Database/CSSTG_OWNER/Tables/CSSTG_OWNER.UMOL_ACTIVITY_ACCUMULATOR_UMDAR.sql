DROP TABLE CSSTG_OWNER.UMOL_ACTIVITY_ACCUMULATOR_UMDAR CASCADE CONSTRAINTS
/

--
-- UMOL_ACTIVITY_ACCUMULATOR_UMDAR  (Table) 
--
CREATE TABLE CSSTG_OWNER.UMOL_ACTIVITY_ACCUMULATOR_UMDAR
(
