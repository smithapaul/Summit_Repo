DROP TABLE CSSTG_OWNER.UMOL_ACTIVITY_ACCUMULATOR_UMOL CASCADE CONSTRAINTS
/

--
-- UMOL_ACTIVITY_ACCUMULATOR_UMOL  (Table) 
--
CREATE TABLE CSSTG_OWNER.UMOL_ACTIVITY_ACCUMULATOR_UMOL
(
