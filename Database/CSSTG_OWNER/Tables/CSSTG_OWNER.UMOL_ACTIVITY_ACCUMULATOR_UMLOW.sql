DROP TABLE CSSTG_OWNER.UMOL_ACTIVITY_ACCUMULATOR_UMLOW CASCADE CONSTRAINTS
/

--
-- UMOL_ACTIVITY_ACCUMULATOR_UMLOW  (Table) 
--
CREATE TABLE CSSTG_OWNER.UMOL_ACTIVITY_ACCUMULATOR_UMLOW
(
