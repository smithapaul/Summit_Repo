DROP TABLE CSSTG_OWNER.PS_ITEM_LINE_SF2 CASCADE CONSTRAINTS
/

--
-- PS_ITEM_LINE_SF2  (Table) 
--
CREATE TABLE CSSTG_OWNER.PS_ITEM_LINE_SF2
(
  ...
  SSF_ITEM_NBR_STCHG  VARCHAR2(15 BYTE)         NOT NULL,
