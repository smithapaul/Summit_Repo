DROP TABLE CSSTG_OWNER.UMOL_ACTIVITY_ACCUMULATOR_UMWOR CASCADE CONSTRAINTS
/

--
-- UMOL_ACTIVITY_ACCUMULATOR_UMWOR  (Table) 
--
CREATE TABLE CSSTG_OWNER.UMOL_ACTIVITY_ACCUMULATOR_UMWOR
(
...
(  
  PARTITION OLD_DATA VALUES LESS THAN (TO_DATE(' 2020-01-01 00:00:00', 'SYYYY-MM-DD HH24:MI:SS', 'NLS_CALENDAR=GREGORIAN'))
    COMPRESS BASIC,  
  PARTITION VALUES LESS THAN (TO_DATE(' 2020-09-01 00:00:00', 'SYYYY-MM-DD HH24:MI:SS', 'NLS_CALENDAR=GREGORIAN'))
    COMPRESS BASIC,  
