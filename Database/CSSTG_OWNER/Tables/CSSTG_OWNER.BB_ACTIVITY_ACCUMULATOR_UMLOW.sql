DROP TABLE CSSTG_OWNER.BB_ACTIVITY_ACCUMULATOR_UMLOW CASCADE CONSTRAINTS
/

--
-- BB_ACTIVITY_ACCUMULATOR_UMLOW  (Table) 
--
CREATE TABLE CSSTG_OWNER.BB_ACTIVITY_ACCUMULATOR_UMLOW
(
