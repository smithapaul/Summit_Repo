DROP TABLE CSSTG_OWNER.BB_ACTIVITY_ACCUMULATOR_UMBOS CASCADE CONSTRAINTS
/

--
-- BB_ACTIVITY_ACCUMULATOR_UMBOS  (Table) 
--
CREATE TABLE CSSTG_OWNER.BB_ACTIVITY_ACCUMULATOR_UMBOS
(
