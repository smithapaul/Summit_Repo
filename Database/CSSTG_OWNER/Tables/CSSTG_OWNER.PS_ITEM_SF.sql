DROP TABLE CSSTG_OWNER.PS_ITEM_SF CASCADE CONSTRAINTS
/

--
-- PS_ITEM_SF  (Table) 
--
CREATE TABLE CSSTG_OWNER.PS_ITEM_SF
(
  ...
  SSF_BILLED_AMOUNT   NUMBER(16,2)              NOT NULL,
  SSF_INSTMNT_ID      INTEGER                   NOT NULL,
