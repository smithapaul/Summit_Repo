DROP TABLE CSSTG_OWNER.PS_DISB_SPLIT_CD CASCADE CONSTRAINTS
/

--
-- PS_DISB_SPLIT_CD  (Table) 
--
CREATE TABLE CSSTG_OWNER.PS_DISB_SPLIT_CD
(
  ...
  EVEN_SPLIT_FLAG    VARCHAR2(1 BYTE)           NOT NULL,
