DROP TABLE CSSTG_OWNER.PS_EVALUATION_TBL_OLD CASCADE CONSTRAINTS
/

--
-- PS_EVALUATION_TBL_OLD  (Table) 
--
CREATE TABLE CSSTG_OWNER.PS_EVALUATION_TBL_OLD
(
  ...
  ADM_EVAL_TYPE    VARCHAR2(1 BYTE)             NOT NULL,
